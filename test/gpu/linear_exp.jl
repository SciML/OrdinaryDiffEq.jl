...
@test_broken isapprox(sol1_gpu, sol_analytic, rtol = 1.0e-6)
@test isapprox(sol2_gpu, sol_analytic, rtol = 1.0e-6)
@test isapprox(sol3_gpu, sol_analytic, rtol = 1.0e-6)
...
@test_broken isapprox(sol2_1_gpu, sol_analytic, rtol = 1.0e-6)
@test isapprox(sol2_2_gpu, sol_analytic, rtol = 1.0e-6)
@test isapprox(sol2_3_gpu, sol_analytic, rtol = 1.0e-6)
