...
import ODEProblemLibrary: prob_ode_bigfloatlinear, prob_ode_bigfloat2Dlinear,
...
@testset "Nordsieck Convergence Tests" begin for i in eachindex(probArr)
...
probArr = [prob_ode_linear,
    prob_ode_2Dlinear]
@testset "Nordsieck Adaptivity Tests: AN5" begin for i in eachindex(probArr)
    prob = probArr[i]
...
@testset "Nordsieck Adaptivity Tests: JVODE" begin for i in eachindex(probArr),
