...
# AlgebraicMultigrid triggers a LAPACK gesdd! bug on Julia 1.10 (lts) when computing
# pseudoinverse during AMG coarsening. Skip AMG preconditioner tests on Julia < 1.11.
const TEST_AMG = VERSION >= v"1.11-"
