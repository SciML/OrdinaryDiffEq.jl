...
# Callback type-erasure (and the wrapping it enables) is restricted to Julia >= 1.12;
# on older versions callbacks stay concretely typed, so these behaviors do not apply.
