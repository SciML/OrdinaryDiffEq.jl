...
sol7 = solve(
    prob,
    KenCarp4(autodiff = false, diff_type = Val{:central}),
    abstol = 1e-12,
    reltol = 1e-12,
)
sol8 = solve(
    prob,
    KenCarp4(autodiff = false, diff_type = Val{:complex}),
    abstol = 1e-12,
    reltol = 1e-12,
)
...
sol11 = solve(
    prob,
    KenCarp47(autodiff = false, diff_type = Val{:central}),
    abstol = 1e-12,
    reltol = 1e-12,
)
sol12 = solve(
    prob,
    KenCarp47(autodiff = false, diff_type = Val{:complex}),
    abstol = 1e-12,
    reltol = 1e-12,
)
...
sol15 = solve(
    prob,
    KenCarp58(autodiff = false, diff_type = Val{:central}),
    abstol = 1e-12,
    reltol = 1e-12,
)
sol16 = solve(
    prob,
    KenCarp58(autodiff = false, diff_type = Val{:complex}),
    abstol = 1e-12,
    reltol = 1e-12,
)
...
working_sdirk_algs =
    [ImplicitMidpoint(), ImplicitEuler(), ImplicitMidpoint(autodiff = false), SSPSDIRK2()]
