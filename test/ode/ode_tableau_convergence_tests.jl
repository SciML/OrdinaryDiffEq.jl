...
for i = 1:2 # 1 = num, 2 = ExplicitRK
  ...
  tab = constructHeun()
  sim = test_convergence(dts,prob,alg=alg,tableau=tab)
  ...
  sim = test_convergence(dts,prob,alg=alg,tableau=tab)
  sim2 = test_convergence(dts,prob,alg=:DP5)
  ...
  sim = test_convergence(dts,prob,alg=alg,tableau=tab) #10
  push!(bools,abs(sim.𝒪est[:l∞]-5) < testTol)
  ...
  sim = test_convergence(dts,prob,alg=alg,tableau=tab) #20
  ...
  sim = test_convergence(dts,bigprob,alg=alg,tableau=tab)
  ...
  sim = test_convergence(dts,prob,alg=alg,tableau=tab) #30
  ...
  dts = 1.//2.^(5:-1:1)
  tab = constructHuta62()
  sim = test_convergence(dts,prob,alg=alg,tableau=tab)#40
  push!(bools,abs(sim.𝒪est[:l∞]-6) < testTol)
  ...
  sim = test_convergence(dts,bigprob,alg=alg,tableau=tab) #50
  push!(bools,abs(sim.𝒪est[:l∞]-7) < testTol)
