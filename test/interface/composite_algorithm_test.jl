...
v = @inferred OrdinaryDiffEq.ode_interpolant(
    1.0,
    integrator1,
    integrator1.opts.save_idxs,
    Val{0},
)
@inferred OrdinaryDiffEq.ode_interpolant!(
    v,
    1.0,
    integrator1,
    integrator1.opts.save_idxs,
...
v = @inferred OrdinaryDiffEq.ode_extrapolant(
    1.0,
    integrator1,
    integrator1.opts.save_idxs,
    Val{0},
)
@inferred OrdinaryDiffEq.ode_extrapolant!(
    v,
    1.0,
    integrator1,
    integrator1.opts.save_idxs,
