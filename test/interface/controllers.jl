...
@testset "qmax_first_step" begin
    ...
    for alg in (Tsit5(), Vern7(), RDPK3SpFSAL49())
        ...
        ctrl_restricted = OrdinaryDiffEqCore.PIController(alg, qmax_first_step = 10)
    ...
    # Test get_current_qmax with controller (custom qmax_first_step)
    ctrl_new = OrdinaryDiffEqCore.PIController(Tsit5(), qmax_first_step = 500)
