...
p = (
    Ka = 2.769674683505292,
    CL = 0.8315548845614537,
    Vc = 45.87339297906569,
    Q = 1.4544520084387496,
    Vp = 9.460961128900388,
    Kin = 6.360418843010778,
    Kout = 3.524234094210465,
    IC50 = 0.4483840673123028,
    IMAX = 1.0,
    γ = 2.0,
)

u0 = [0.35793622925128044, 0.7123008259214687, 0.10685666303615937, 0.00]
