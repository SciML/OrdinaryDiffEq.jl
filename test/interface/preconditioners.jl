...
jac = ModelingToolkit.Symbolics.jacobian_sparsity(
    (du, u) -> brusselator_2d_loop(du, u, p, 0.0),
    du0,
    u0,
)

prob_ode_brusselator_2d_sparse = ODEProblem(
    ODEFunction(brusselator_2d_loop, jac_prototype = float.(jac)),
    u0,
    (0.0, 11.5),
    p,
)
...
sol2 = solve(
    ...
    KenCarp47(linsolve = KrylovJL_GMRES(), precs = incompletelu, concrete_jac = true),
    save_everystep = false,
);
iter2 = iter[];
iter[] = 0;
sol3 = solve(
    prob_ode_brusselator_2d_sparse,
    KenCarp47(linsolve = KrylovJL_GMRES(), precs = algebraicmultigrid, concrete_jac = true),
    save_everystep = false,
);
iter3 = iter[];
iter[] = 0;
...
sol2 = solve(
    prob_ode_brusselator_2d_sparse,
    Rosenbrock23(linsolve = KrylovJL_GMRES(), precs = incompletelu, concrete_jac = true),
    save_everystep = false,
);
iter2 = iter[];
iter[] = 0;
...
sol1 = solve(
    prob_ode_brusselator_2d,
    Rodas4(linsolve = KrylovJL_GMRES()),
    save_everystep = false,
);
iter1 = iter[];
iter[] = 0;
...
sol3 = solve(
    prob_ode_brusselator_2d_sparse,
    Rodas4(linsolve = KrylovJL_GMRES(), precs = algebraicmultigrid, concrete_jac = true),
    save_everystep = false,
);
iter3 = iter[];
iter[] = 0;
sol4 = solve(
    prob_ode_brusselator_2d_sparse,
    Rodas4(linsolve = KrylovJL_GMRES(), precs = algebraicmultigrid2, concrete_jac = true),
    save_everystep = false,
);
iter4 = iter[];
iter[] = 0;
...
sol1 = solve(
    prob_ode_brusselator_2d,
    Rodas5(linsolve = KrylovJL_GMRES()),
    save_everystep = false,
);
iter1 = iter[];
iter[] = 0;
...
sol3 = solve(
    prob_ode_brusselator_2d_sparse,
    Rodas5(linsolve = KrylovJL_GMRES(), precs = algebraicmultigrid, concrete_jac = true),
    save_everystep = false,
);
iter3 = iter[];
iter[] = 0;
sol4 = solve(
    prob_ode_brusselator_2d_sparse,
    Rodas5(linsolve = KrylovJL_GMRES(), precs = algebraicmultigrid2, concrete_jac = true),
    save_everystep = false,
);
iter4 = iter[];
iter[] = 0;
...
sol3 = solve(
    prob_ode_brusselator_2d_sparse,
    TRBDF2(linsolve = KrylovJL_GMRES(), precs = algebraicmultigrid, concrete_jac = true),
    save_everystep = false,
);
iter3 = iter[];
iter[] = 0;
sol4 = solve(
    prob_ode_brusselator_2d_sparse,
    TRBDF2(linsolve = KrylovJL_GMRES(), precs = algebraicmultigrid2, concrete_jac = true),
    save_everystep = false,
);
iter4 = iter[];
iter[] = 0;
