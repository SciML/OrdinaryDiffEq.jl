...
struct RadauIIA5{CS,AD,F,F2,FDT,T2,Tol,Controller} <: OrdinaryDiffEqNewtonAdaptiveAlgorithm{CS,AD,Controller}
  linsolve::F
  nlsolve::F2
  diff_type::FDT
  extrapolant::Symbol
...
RadauIIA5(;chunk_size=0,autodiff=true,diff_type=Val{:central},
                          ...
                          tol=nothing,max_iter=10,min_iter=1) =
                          RadauIIA5{chunk_size,autodiff,typeof(linsolve),
                          typeof(nlsolve),typeof(diff_type),
                          typeof(new_jac_conv_bound),typeof(tol),controller}(linsolve,
                          nlsolve,diff_type,extrapolant,
