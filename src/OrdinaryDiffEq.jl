...
using DocStringExtensions
  ...
  SnoopPrecompile.@precompile_all_calls begin
      ...
      solver_list = [
        ...
        Rodas4(), Rodas4(autodiff=false), Rodas4(chunk_size = 1),
        Rodas4(chunk_size = Val{1}()),

        Rodas5(), Rodas5(autodiff=false), Rodas5(chunk_size = 1),
        Rodas5(chunk_size = Val{1}()),

        Rodas5P(), Rodas5P(autodiff=false), Rodas5P(chunk_size = 1),
        Rodas5P(chunk_size = Val{1}()),

        TRBDF2(), TRBDF2(autodiff=false), TRBDF2(chunk_size = 1),
        TRBDF2(chunk_size = Val{1}()),

        KenCarp4(), KenCarp4(autodiff=false), KenCarp4(chunk_size = 1),
        KenCarp4(chunk_size = Val{1}()),

        QNDF(), QNDF(autodiff=false), QNDF(chunk_size = 1),
        QNDF(chunk_size = Val{1}()),
