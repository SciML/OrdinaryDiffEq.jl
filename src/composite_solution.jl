...
function DiffEqBase.build_solution(
    ...
    alg::OrdinaryDiffEqCompositeAlgorithm,
    t,
    u;
    ...
    k = [],
    du = [],
    interp = !isempty(du) ? DiffEqBase.HermiteInterpolation(t, u, du) :
...
function DiffEqBase.solution_new_retcode(
    sol::ODECompositeSolution{T,N,uType,uType2,EType,tType,rateType,P,A,IType,DE},
    retcode,
) where {T,N,uType,uType2,EType,tType,rateType,P,A,IType,DE}
...
function DiffEqBase.solution_new_tslocation(
    sol::ODECompositeSolution{T,N,uType,uType2,EType,tType,rateType,P,A,IType,DE},
    tslocation,
) where {T,N,uType,uType2,EType,tType,rateType,P,A,IType,DE}
    ODECompositeSolution{T,N,uType,uType2,EType,tType,rateType,P,A,IType,DE}(
