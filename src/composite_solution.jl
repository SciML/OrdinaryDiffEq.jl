struct ODECompositeSolution{T,N,uType,uType2,EType,tType,rateType,P,A,IType,StatType} <: DiffEqBase.AbstractODESolution{T,N}
  u::uType
  u_analytic::uType2
  errors::EType
  t::tType
...
function DiffEqBase.solution_new_retcode(sol::ODECompositeSolution{T,N,uType,uType2,EType,tType,rateType,P,A,IType,StatType},retcode) where {T,N,uType,uType2,EType,tType,rateType,P,A,IType,StatType}
 ...
 function DiffEqBase.solution_new_tslocation(sol::ODECompositeSolution{
   T,N,uType,uType2,EType,tType,rateType,P,A,IType,StatType},tslocation) where {T,N,uType,uType2,EType,tType,rateType,P,A,IType,StatType}
