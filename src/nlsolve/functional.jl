...
@muladd function initialize!(nlsolver::NLSolver{<:NLFunctional}, integrator::DiffEqBase.DEIntegrator)
    nlsolver.cache.tstep = integrator.t + nlsolver.c * integrator.dt

    nothing
end

@muladd function initialize!(nlsolver::NLSolver{<:NLAnderson}, integrator::DiffEqBase.DEIntegrator)
