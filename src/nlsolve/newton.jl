...
@muladd function initialize!(nlcache::NLNewtonConstantCache,
...
@muladd function initialize!(nlcache::NLNewtonCache,
...
@muladd function compute_step!(nlsolver::NLSolver{<:NLNewton,true}, integrator)
  ...
  @unpack ustep,ztmp,tstep,atmp,k,W,new_W,linsolve,weight,invγdt = cache
