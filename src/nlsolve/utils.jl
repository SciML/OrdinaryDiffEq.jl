...
setfirststage!(nlcache::Union{NLNewtonCache,NLNewtonConstantCache}, val::Bool) =
...
function build_nlsolver(
    alg,
    nlalg::Union{NLFunctional,NLAnderson,NLNewton},
    u,
    uprev,
    p,
    t,
    ...
    if nlalg isa NLNewton
        ...
        linsolve =
            init(linprob, alg.linsolve, alias_A = true, alias_b = true, Pl = Pl, Pr = Pr)
