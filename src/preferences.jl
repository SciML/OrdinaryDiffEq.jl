...
"""
function set_snoop_precompile!(
    include_snoop_precompile::Bool = true;
...
const INCLUDE_SNOOP_PRECOMPILE = load_preference(@__MODULE__, "include_snoop_precompile", true)
