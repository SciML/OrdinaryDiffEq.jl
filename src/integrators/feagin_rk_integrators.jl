function initialize!(integrator,cache::Feagin10ConstantCache,f=integrator.f)
...
#=
@muladd function perform_step!(integrator,cache::Feagin10ConstantCache,f=integrator.f)
...
function initialize!(integrator,cache::Feagin10Cache,f=integrator.f)
...
#=
@muladd function perform_step!(integrator,cache::Feagin10Cache,f=integrator.f)
  @unpack t,dt,uprev,u = integrator
...
function initialize!(integrator,cache::Feagin12ConstantCache,f=integrator.f)
  integrator.fsalfirst = f(integrator.t,integrator.uprev) # Pre-start fsal
  integrator.kshortsize = 2
  integrator.k = eltype(integrator.sol.k)(integrator.kshortsize)
...
#=
@muladd function perform_step!(integrator,cache::Feagin12ConstantCache,f=integrator.f)
  @unpack t,dt,uprev,u = integrator
...
function initialize!(integrator,cache::Feagin12Cache,f=integrator.f)
  integrator.fsalfirst = cache.fsalfirst
  integrator.fsallast = cache.k
  integrator.kshortsize = 2
  integrator.k = eltype(integrator.sol.k)(integrator.kshortsize)
...
#=
@muladd function perform_step!(integrator,cache::Feagin12Cache,f=integrator.f)
  @unpack t,dt,uprev,u = integrator
...
#=
@muladd function perform_step!(integrator,cache::Feagin14ConstantCache,f=integrator.f)
  @unpack t,dt,uprev,u = integrator
...
function initialize!(integrator,cache::Feagin14Cache,f=integrator.f)
  integrator.fsalfirst = cache.fsalfirst
  integrator.fsallast = cache.k
  integrator.kshortsize = 2
  integrator.k = eltype(integrator.sol.k)(integrator.kshortsize)
...
#=
@muladd function perform_step!(integrator,cache::Feagin14Cache,f=integrator.f)
  @unpack t,dt,uprev,u = integrator
