@inline function initialize!(integrator::ODEIntegrator,cache::Feagin10ConstantCache,f=integrator.f)
  integrator.fsalfirst = f(integrator.t,integrator.uprev) # Pre-start fsal
  integrator.kshortsize = 2
  integrator.k = eltype(integrator.sol.k)(integrator.kshortsize)
end

@inline function perform_step!(integrator::ODEIntegrator,cache::Feagin10ConstantCache,f=integrator.f)
...
@inline function initialize!(integrator::ODEIntegrator,cache::Feagin10Cache,f=integrator.f)
...
@inline function perform_step!(integrator::ODEIntegrator,cache::Feagin10Cache,f=integrator.f)
  @unpack t,dt,uprev,u,k = integrator
...
@inline function initialize!(integrator::ODEIntegrator,cache::Feagin12ConstantCache,f=integrator.f)
  integrator.fsalfirst = f(integrator.t,integrator.uprev) # Pre-start fsal
  integrator.kshortsize = 2
  integrator.k = eltype(integrator.sol.k)(integrator.kshortsize)
end

@inline function perform_step!(integrator::ODEIntegrator,cache::Feagin12ConstantCache,f=integrator.f)
  @unpack t,dt,uprev,u,k = integrator
...
@inline function initialize!(integrator::ODEIntegrator,cache::Feagin12Cache,f=integrator.f)
  integrator.fsalfirst = cache.fsalfirst
  integrator.fsallast = cache.k
  integrator.kshortsize = 2
  integrator.k = eltype(integrator.sol.k)(integrator.kshortsize)
...
@inline function perform_step!(integrator::ODEIntegrator,cache::Feagin12Cache,f=integrator.f)
  @unpack t,dt,uprev,u,k = integrator
  uidx = eachindex(integrator.uprev)
...
@inline function initialize!(integrator::ODEIntegrator,cache::Feagin14ConstantCache,f=integrator.f)
  integrator.fsalfirst = f(integrator.t,integrator.uprev) # Pre-start fsal
  integrator.kshortsize = 2
  integrator.k = eltype(integrator.sol.k)(integrator.kshortsize)
end

@inline function perform_step!(integrator::ODEIntegrator,cache::Feagin14ConstantCache,f=integrator.f)
  @unpack t,dt,uprev,u,k = integrator
...
@inline function initialize!(integrator::ODEIntegrator,cache::Feagin14Cache,f=integrator.f)
  integrator.fsalfirst = cache.fsalfirst
  integrator.fsallast = cache.k
  integrator.kshortsize = 2
  integrator.k = eltype(integrator.sol.k)(integrator.kshortsize)
...
@inline function perform_step!(integrator::ODEIntegrator,cache::Feagin14Cache,f=integrator.f)
  @unpack t,dt,uprev,u,k = integrator
  uidx = eachindex(integrator.uprev)
