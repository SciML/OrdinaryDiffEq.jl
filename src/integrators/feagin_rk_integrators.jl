...
@inline function perform_step!(integrator::ODEIntegrator,cache::Feagin10Cache)
  ...
  @unpack k1,k2,k3,k4,k5,k6,k7,k8,k9,k10,k11,k12,k13,k14,k15,k16,k17,tmp,atmp,uprev,k = cache
  for i in uidx
...
@inline function perform_step!(integrator::ODEIntegrator,cache::Feagin12Cache)
  ...
  @unpack k1,k2,k3,k4,k5,k6,k7,k8,k9,k10,k11,k12,k13,k14,k15,k16,k17,k18,k19,k20,k21,k22,k23,k24,k25,tmp,atmp,uprev,k = cache
  for i in uidx
    tmp[i] = uprev[i] + dt*(a0100*k1[i])
  end
  f(t + c1*dt,tmp,k2)
...
@inline function perform_step!(integrator::ODEIntegrator,cache::Feagin14Cache)
  ...
  @unpack k1,k2,k3,k4,k5,k6,k7,k8,k9,k10,k11,k12,k13,k14,k15,k16,k17,k18,k19,k20,k21,k22,k23,k24,k25,k26,k27,k28,k29,k30,k31,k32,k33,k34,k35,tmp,atmp,uprev,k = cache
  f(t,uprev,k1)
  for i in uidx
    tmp[i] = uprev[i] + dt*(a0100*k1[i])
  end
