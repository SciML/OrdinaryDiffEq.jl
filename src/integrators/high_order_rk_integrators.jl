...
@inline function perform_step!(integrator,cache::TanYam7ConstantCache,f=integrator.f)
  ...
  k8 = f(@muladd(t + c7*dt),uprev+dt*(a81*k1       +a83*k3+a84*k4+a85*k5+a86*k6+a87*k7))
...
@inline function perform_step!(integrator,cache::DP8ConstantCache,f=integrator.f)
  ...
  if integrator.opts.calck
    ...
    k14 = f(@muladd(t + c14*dt),uprev+dt*(a1401*k1         +a1407*k7+a1408*k8+a1409*k9+a1410*k10+a1411*k11+a1412*k12+a1413*k13))
    k15 = f(@muladd(t + c15*dt),uprev+dt*(a1501*k1+a1506*k6+a1507*k7+a1508*k8                   +a1511*k11+a1512*k12+a1513*k13+a1514*k14))
    k16 = f(@muladd(t + c16*dt),uprev+dt*(a1601*k1+a1606*k6+a1607*k7+a1608*k8+a1609*k9                              +a1613*k13+a1614*k14+a1615*k15))
    udiff = kupdate
...
@inline function perform_step!(integrator,cache::TsitPap8ConstantCache,f=integrator.f)
  ...
  k8 = f(@muladd(t + c7*dt),uprev+dt*(a0801*k1                +a0804*k4+a0805*k5+a0806*k6+a0807*k7))
  k9 = f(@muladd(t + c8*dt),uprev+dt*(a0901*k1                +a0904*k4+a0905*k5+a0906*k6+a0907*k7+a0908*k8))
  k10 =f(@muladd(t + c9*dt),uprev+dt*(a1001*k1                +a1004*k4+a1005*k5+a1006*k6+a1007*k7+a1008*k8+a1009*k9))
  k11= f(@muladd(t + c10*dt),uprev+dt*(a1101*k1                +a1104*k4+a1105*k5+a1106*k6+a1107*k7+a1108*k8+a1109*k9+a1110*k10))
  k12= f(t+dt,uprev+dt*(a1201*k1                +a1204*k4+a1205*k5+a1206*k6+a1207*k7+a1208*k8+a1209*k9+a1210*k10+a1211*k11))
