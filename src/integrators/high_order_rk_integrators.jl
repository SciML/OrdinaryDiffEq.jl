...
@inline function perform_step!(integrator,cache::TanYam7Cache,f=integrator.f)
  ...
  for i in uidx
    tmp[i] = @muladd uprev[i]+dt*(a91*k1[i]+a93*k3[i]+a94*k4[i]+a95*k5[i]+a96*k6[i]+a97*k7[i]+a98*k8[i])
  end
  f(t+dt,tmp,k9)
  for i in uidx
    tmp[i] = @muladd uprev[i]+dt*(a101*k1[i]+a103*k3[i]+a104*k4[i]+a105*k5[i]+a106*k6[i]+a107*k7[i]+a108*k8[i])
  end
  f(t+dt,tmp,k10)
  for i in uidx
...
@inline function perform_step!(integrator,cache::DP8Cache,f=integrator.f)
  ...
  f(t+dt,tmp,k12)
  for i in uidx
    kupdate[i] = @muladd b1*k1[i]+b6*k6[i]+b7*k7[i]+b8*k8[i]+b9*k9[i]+b10*k10[i]+b11*k11[i]+b12*k12[i]
  ...
  if integrator.opts.calck
    ...
    for i in uidx
      tmp[i] = @muladd uprev[i]+dt*(a1401*k1[i]+a1407*k7[i]+a1408*k8[i]+a1409*k9[i]+a1410*k10[i]+a1411*k11[i]+a1412*k12[i]+a1413*k13[i])
    end
    f(@muladd(t + c14*dt),tmp,k14)
    for i in uidx
      tmp[i] = @muladd uprev[i]+dt*(a1501*k1[i]+a1506*k6[i]+a1507*k7[i]+a1508*k8[i]+a1511*k11[i]+a1512*k12[i]+a1513*k13[i]+a1514*k14[i])
    end
    f(@muladd(t + c15*dt),tmp,k15)
    for i in uidx
      tmp[i] = @muladd uprev[i]+dt*(a1601*k1[i]+a1606*k6[i]+a1607*k7[i]+a1608*k8[i]+a1609*k9[i]+a1613*k13[i]+a1614*k14[i]+a1615*k15[i])
    end
    ...
    for i in uidx
      ...
      integrator.k[4][i] = @muladd(d401*k1[i]+d406*k6[i]+d407*k7[i]+d408*k8[i]+d409*k9[i]+d410*k10[i]+d411*k11[i]+d412*k12[i]+d413*k13[i]+d414*k14[i]+d415*k15[i]+d416*k16[i])
      integrator.k[5][i] = @muladd(d501*k1[i]+d506*k6[i]+d507*k7[i]+d508*k8[i]+d509*k9[i]+d510*k10[i]+d511*k11[i]+d512*k12[i]+d513*k13[i]+d514*k14[i]+d515*k15[i]+d516*k16[i])
      integrator.k[6][i] = @muladd(d601*k1[i]+d606*k6[i]+d607*k7[i]+d608*k8[i]+d609*k9[i]+d610*k10[i]+d611*k11[i]+d612*k12[i]+d613*k13[i]+d614*k14[i]+d615*k15[i]+d616*k16[i])
      integrator.k[7][i] = @muladd(d701*k1[i]+d706*k6[i]+d707*k7[i]+d708*k8[i]+d709*k9[i]+d710*k10[i]+d711*k11[i]+d712*k12[i]+d713*k13[i]+d714*k14[i]+d715*k15[i]+d716*k16[i])
    end
  end
  @pack integrator = t,dt,u,k
end
...
@inline function perform_step!(integrator,cache::TsitPap8Cache,f=integrator.f)
  ...
  f(t+dt,tmp,k13)
  for i in uidx
    update[i] = dt*@muladd(b1*k1[i]+b6*k6[i]+b7*k7[i]+b8*k8[i]+b9*k9[i]+b10*k10[i]+b11*k11[i]+b12*k12[i])
    u[i] = uprev[i] + update[i]
  end
  if integrator.opts.adaptive
    for i in uidx
