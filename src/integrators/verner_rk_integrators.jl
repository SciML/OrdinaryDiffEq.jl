...
@inline function perform_step!(integrator,cache::Vern6Cache,f=integrator.f)
  ...
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a41*k1[i]+a43*k3[i]))
  end
  f(@muladd(t + c3*dt),tmp,k4)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a51*k1[i]+a53*k3[i]+a54*k4[i]))
  end
  f(@muladd(t + c4*dt),tmp,k5)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a61*k1[i]+a63*k3[i]+a64*k4[i]+a65*k5[i]))
  end
  f(@muladd(t + c5*dt),tmp,k6)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a71*k1[i]+a73*k3[i]+a74*k4[i]+a75*k5[i]+a76*k6[i]))
  end
  f(@muladd(t + c6*dt),tmp,k7)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a81*k1[i]+a83*k3[i]+a84*k4[i]+a85*k5[i]+a86*k6[i]+a87*k7[i]))
  end
  f(t+dt,tmp,k8)
  for i in uidx
    u[i]=@muladd(uprev[i]+dt*(a91*k1[i]+a94*k4[i]+a95*k5[i]+a96*k6[i]+a97*k7[i]+a98*k8[i]))
  end
  f(t+dt,u,k9)
  if integrator.opts.adaptive
    for i in uidx
...
@inline function perform_step!(integrator,cache::Vern7Cache,f=integrator.f)
  ...
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a031*k1[i]+a032*k2[i]))
  end
  f(@muladd(t + c3*dt),tmp,k3)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a041*k1[i]+a043*k3[i]))
  end
  f(@muladd(t + c4*dt),tmp,k4)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a051*k1[i]+a053*k3[i]+a054*k4[i]))
  end
  f(@muladd(t + c5*dt),tmp,k5)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a061*k1[i]+a063*k3[i]+a064*k4[i]+a065*k5[i]))
  end
  f(@muladd(t + c6*dt),tmp,k6)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a071*k1[i]+a073*k3[i]+a074*k4[i]+a075*k5[i]+a076*k6[i]))
  end
  f(@muladd(t + c7*dt),tmp,k7)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a081*k1[i]+a083*k3[i]+a084*k4[i]+a085*k5[i]+a086*k6[i]+a087*k7[i]))
  end
  f(@muladd(t + c8*dt),tmp,k8)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a091*k1[i]+a093*k3[i]+a094*k4[i]+a095*k5[i]+a096*k6[i]+a097*k7[i]+a098*k8[i]))
  end
  f(t+dt,tmp,k9)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a101*k1[i]+a103*k3[i]+a104*k4[i]+a105*k5[i]+a106*k6[i]+a107*k7[i]))
  end
  f(t+dt,tmp,k10)
  for i in uidx
    update[i] = dt*(@muladd(k1[i]*b1 + k4[i]*b4 + k5[i]*b5 + k6[i]*b6 + k7[i]*b7 + k8[i]*b8 + k9[i]*b9))
...
@inline function perform_step!(integrator,cache::Vern8Cache,f=integrator.f)
  ...
  f(@muladd(t + c2*dt),tmp,k2)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a0301*k1[i]+a0302*k2[i]))
  end
  f(@muladd(t + c3*dt),tmp,k3)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a0401*k1[i]+a0403*k3[i]))
  end
  f(@muladd(t + c4*dt),tmp,k4)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a0501*k1[i]+a0503*k3[i]+a0504*k4[i]))
  end
  f(@muladd(t + c5*dt),tmp,k5)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a0601*k1[i]+a0604*k4[i]+a0605*k5[i]))
  end
  f(@muladd(t + c6*dt),tmp,k6)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a0701*k1[i]+a0704*k4[i]+a0705*k5[i]+a0706*k6[i]))
  end
  f(@muladd(t + c7*dt),tmp,k7)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a0801*k1[i]+a0804*k4[i]+a0805*k5[i]+a0806*k6[i]+a0807*k7[i]))
  end
  f(@muladd(t + c8*dt),tmp,k8)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a0901*k1[i]+a0904*k4[i]+a0905*k5[i]+a0906*k6[i]+a0907*k7[i]+a0908*k8[i]))
  end
  f(@muladd(t + c9*dt),tmp,k9)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a1001*k1[i]+a1004*k4[i]+a1005*k5[i]+a1006*k6[i]+a1007*k7[i]+a1008*k8[i]+a1009*k9[i]))
  end
  f(@muladd(t + c10*dt),tmp,k10)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a1101*k1[i]+a1104*k4[i]+a1105*k5[i]+a1106*k6[i]+a1107*k7[i]+a1108*k8[i]+a1109*k9[i]+a1110*k10[i]))
  end
  f(@muladd(t + c11*dt),tmp,k11)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a1201*k1[i]+a1204*k4[i]+a1205*k5[i]+a1206*k6[i]+a1207*k7[i]+a1208*k8[i]+a1209*k9[i]+a1210*k10[i]+a1211*k11[i]))
  end
  f(t+dt,tmp,k12)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a1301*k1[i]+a1304*k4[i]+a1305*k5[i]+a1306*k6[i]+a1307*k7[i]+a1308*k8[i]+a1309*k9[i]+a1310*k10[i]))
  end
  f(t+dt,tmp,k13)
  for i in uidx
    update[i] = dt*(@muladd(k1[i]*b1 + k6[i]*b6 + k7[i]*b7 + k8[i]*b8 + k9[i]*b9 + k10[i]*b10 + k11[i]*b11 + k12[i]*b12))
    u[i] = uprev[i] + update[i]
  end
  if integrator.opts.adaptive
    for i in uidx
...
@inline function perform_step!(integrator,cache::Vern9Cache,f=integrator.f)
  ...
  f(@muladd(t + c6*dt),tmp,k7)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a0801*k1[i]+a0806*k6[i]+a0807*k7[i]))
  end
  f(@muladd(t + c7*dt),tmp,k8)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a0901*k1[i]+a0906*k6[i]+a0907*k7[i]+a0908*k8[i]))
  end
  f(@muladd(t + c8*dt),tmp,k9)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a1001*k1[i]+a1006*k6[i]+a1007*k7[i]+a1008*k8[i]+a1009*k9[i]))
  end
  f(@muladd(t + c9*dt),tmp,k10)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a1101*k1[i]+a1106*k6[i]+a1107*k7[i]+a1108*k8[i]+a1109*k9[i]+a1110*k10[i]))
  end
  f(@muladd(t + c10*dt),tmp,k11)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a1201*k1[i]+a1206*k6[i]+a1207*k7[i]+a1208*k8[i]+a1209*k9[i]+a1210*k10[i]+a1211*k11[i]))
  end
  f(@muladd(t + c11*dt),tmp,k12)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a1301*k1[i]+a1306*k6[i]+a1307*k7[i]+a1308*k8[i]+a1309*k9[i]+a1310*k10[i]+a1311*k11[i]+a1312*k12[i]))
  end
  f(@muladd(t + c12*dt),tmp,k13)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a1401*k1[i]+a1406*k6[i]+a1407*k7[i]+a1408*k8[i]+a1409*k9[i]+a1410*k10[i]+a1411*k11[i]+a1412*k12[i]+a1413*k13[i]))
  end
  f(@muladd(t + c13*dt),tmp,k14)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a1501*k1[i]+a1506*k6[i]+a1507*k7[i]+a1508*k8[i]+a1509*k9[i]+a1510*k10[i]+a1511*k11[i]+a1512*k12[i]+a1513*k13[i]+a1514*k14[i]))
  end
  f(t+dt,tmp,k15)
  for i in uidx
    tmp[i] = @muladd(uprev[i]+dt*(a1601*k1[i]+a1606*k6[i]+a1607*k7[i]+a1608*k8[i]+a1609*k9[i]+a1610*k10[i]+a1611*k11[i]+a1612*k12[i]+a1613*k13[i]))
  end
  f(t+dt,tmp,k16)
  for i in uidx
    update[i] = dt*(@muladd(k1[i]*b1+k8[i]*b8+k9[i]*b9+k10[i]*b10+k11[i]*b11+k12[i]*b12+k13[i]*b13+k14[i]*b14+k15[i]*b15))
    u[i] = uprev[i] + update[i]
  end
  if integrator.opts.adaptive
    for i in uidx
