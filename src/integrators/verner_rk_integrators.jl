...
@inline function perform_step!(integrator,cache::Vern6ConstantCache,f=integrator.f)
  ...
  k2 = f(@muladd(t + c1*dt),uprev+dt*(a21*k1))
  k3 = f(@muladd(t + c2*dt),uprev+dt*(a31*k1+a32*k2))
  k4 = f(@muladd(t + c3*dt),uprev+dt*(a41*k1       +a43*k3))
  k5 = f(@muladd(t + c4*dt),uprev+dt*(a51*k1       +a53*k3+a54*k4))
...
@inline function perform_step!(integrator,cache::Vern7ConstantCache,f=integrator.f)
  ...
  k1 = f(t,uprev)
  k2 = f(@muladd(t + c2*dt),uprev+dt*(a021*k1))
  k3 = f(@muladd(t + c3*dt),uprev+dt*(a031*k1+a032*k2))
  k4 = f(@muladd(t + c4*dt),uprev+dt*(a041*k1       +a043*k3))
  k5 = f(@muladd(t + c5*dt),uprev+dt*(a051*k1       +a053*k3+a054*k4))
  k6 = f(@muladd(t + c6*dt),uprev+dt*(a061*k1       +a063*k3+a064*k4+a065*k5))
  k7 = f(@muladd(t + c7*dt),uprev+dt*(a071*k1       +a073*k3+a074*k4+a075*k5+a076*k6))
  k8 = f(@muladd(t + c8*dt),uprev+dt*(a081*k1       +a083*k3+a084*k4+a085*k5+a086*k6+a087*k7))
...
@inline function perform_step!(integrator,cache::Vern8ConstantCache,f=integrator.f)
  ...
  k1 = f(t,uprev)
  k2 = f(@muladd(t + c2*dt) ,uprev+dt*(a0201*k1))
  k3 = f(@muladd(t + c3*dt) ,uprev+dt*(a0301*k1+a0302*k2))
  k4 = f(@muladd(t + c4*dt) ,uprev+dt*(a0401*k1       +a0403*k3))
  k5 = f(@muladd(t + c5*dt) ,uprev+dt*(a0501*k1       +a0503*k3+a0504*k4))
  k6 = f(@muladd(t + c6*dt) ,uprev+dt*(a0601*k1                +a0604*k4+a0605*k5))
  k7 = f(@muladd(t + c7*dt) ,uprev+dt*(a0701*k1                +a0704*k4+a0705*k5+a0706*k6))
  k8 = f(@muladd(t + c8*dt) ,uprev+dt*(a0801*k1                +a0804*k4+a0805*k5+a0806*k6+a0807*k7))
  k9 = f(@muladd(t + c9*dt) ,uprev+dt*(a0901*k1                +a0904*k4+a0905*k5+a0906*k6+a0907*k7+a0908*k8))
  k10= f(@muladd(t + c10*dt),uprev+dt*(a1001*k1                +a1004*k4+a1005*k5+a1006*k6+a1007*k7+a1008*k8+a1009*k9))
  k11= f(@muladd(t + c11*dt),uprev+dt*(a1101*k1                +a1104*k4+a1105*k5+a1106*k6+a1107*k7+a1108*k8+a1109*k9+a1110*k10))
...
@inline function perform_step!(integrator,cache::Vern9ConstantCache,f=integrator.f)
  ...
  k1 = f(t,uprev)
  k2 = f(@muladd(t + c1*dt),uprev+dt*(a0201*k1))
  k3 = f(@muladd(t + c2*dt),uprev+dt*(a0301*k1+a0302*k2))
  k4 = f(@muladd(t + c3*dt),uprev+dt*(a0401*k1       +a0403*k3))
  k5 = f(@muladd(t + c4*dt),uprev+dt*(a0501*k1       +a0503*k3+a0504*k4))
  k6 = f(@muladd(t + c5*dt),uprev+dt*(a0601*k1                +a0604*k4+a0605*k5))
  k7 = f(@muladd(t + c6*dt),uprev+dt*(a0701*k1                +a0704*k4+a0705*k5+a0706*k6))
  k8 = f(@muladd(t + c7*dt),uprev+dt*(a0801*k1                                  +a0806*k6+a0807*k7))
  k9 = f(@muladd(t + c8*dt),uprev+dt*(a0901*k1                                  +a0906*k6+a0907*k7+a0908*k8))
  k10 =f(@muladd(t + c9*dt),uprev+dt*(a1001*k1                                  +a1006*k6+a1007*k7+a1008*k8+a1009*k9))
  k11= f(@muladd(t + c10*dt),uprev+dt*(a1101*k1                                  +a1106*k6+a1107*k7+a1108*k8+a1109*k9+a1110*k10))
  k12= f(@muladd(t + c11*dt),uprev+dt*(a1201*k1                                  +a1206*k6+a1207*k7+a1208*k8+a1209*k9+a1210*k10+a1211*k11))
  k13= f(@muladd(t + c12*dt),uprev+dt*(a1301*k1                                  +a1306*k6+a1307*k7+a1308*k8+a1309*k9+a1310*k10+a1311*k11+a1312*k12))
  k14= f(@muladd(t + c13*dt),uprev+dt*(a1401*k1                                  +a1406*k6+a1407*k7+a1408*k8+a1409*k9+a1410*k10+a1411*k11+a1412*k12+a1413*k13))
