...
function loopfooter!(integrator)
  ...
  integrator.destat.nf = DiffEqBase.nfeval(integrator.f)
  (integrator.cache isa CompositeCache && integrator.eigen_est > integrator.destat.maxeig) && (integrator.destat.maxeig = integrator.eigen_est)
  nothing
end
