...
function Base.show(io::IO, t::Type{ODEIntegrator{algType, IIP,
                            uType, duType, tType, pType, eigenType, EEstT, QT, tdirType,
                            ksEltype, SolType, F, CacheType, O, FSALType, EventErrorType,
                            ...
                            CallbackCacheType, IA}
    if TruncatedStacktraces.VERBOSE[]
        print(io, "ODEIntegrator{$algType,$IIP,$uType,$duType,$tType,$pType,$eigenType,$EEstT,$QT,$tdirType,$ksEltype,$SolType,$F,$CacheType,$O,$FSALType,$EventErrorType,$CallbackCacheType,$IA}")
    else
