@muladd function DiffEqBase.addsteps!(k, t, uprev, u, dt, f, p, cache::DP8ConstantCache,
...
@muladd function DiffEqBase.addsteps!(k, t, uprev, u, dt, f, p, cache::DP8Cache,
                                      always_calc_begin = false, allow_calc_end = true,
                                      force_calc_end = false)
    if length(k) < 7 || always_calc_begin
