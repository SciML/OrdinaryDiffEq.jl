@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
    ...
    idxs, T::Type{Val{0}}, differential_vars=trues(size(y₀)))
    y₀
end
...
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k, cache::DP5ConstantCache, idxs::Nothing,
    T::Type{Val{0}}, differential_vars=trues(size(y₀)))
    @dp5pre0
...
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
    cache::Union{DP5ConstantCache, DP5Cache}, idxs::Nothing,
    T::Type{Val{1}}, differential_vars=trues(size(y₀)))
    @dp5pre1
...
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
    cache::Union{DP5ConstantCache, DP5Cache}, idxs::Nothing,
    T::Type{Val{2}}, differential_vars=trues(size(y₀)))
    @dp5pre2
...
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
    cache::Union{DP5ConstantCache, DP5Cache}, idxs::Nothing,
    T::Type{Val{3}}, differential_vars=trues(size(y₀)))
    @dp5pre3
...
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
    cache::Union{DP5ConstantCache, DP5Cache}, idxs::Nothing,
    T::Type{Val{4}}, differential_vars=trues(size(y₀)))
    @dp5pre4
...
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
    ...
    idxs::Nothing, T::Type{Val{0}}, differential_vars=trues(size(y₀)))
    @ssprkpre0
...
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
    cache::Union{SSPRK22ConstantCache, SSPRK22Cache,
        ...
        SSPRK43ConstantCache, SSPRK43Cache,
        SSPRK432ConstantCache, SSPRK432Cache},
    idxs::Nothing, T::Type{Val{1}}, differential_vars=trues(size(y₀)))
    @ssprkpre1
...
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
    cache::Union{SSPRK22ConstantCache, SSPRK22Cache,
        ...
        SSPRK43ConstantCache, SSPRK43Cache,
        SSPRK432ConstantCache, SSPRK432Cache},
    idxs::Nothing, T::Type{Val{2}}, differential_vars=trues(size(y₀)))
    @ssprkpre2
...
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
    cache::Union{Tsit5ConstantCache, Tsit5Cache},
    idxs::Nothing, T::Type{Val{3}}, differential_vars=trues(size(y₀)))
    @tsit5pre3
...
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
    cache::Union{Tsit5ConstantCache, Tsit5Cache},
    idxs::Nothing, T::Type{Val{4}}, differential_vars=trues(size(y₀)))
    @tsit5pre4
...
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
    cache::Union{OwrenZen3ConstantCache, OwrenZen3Cache},
    idxs, T::Type{Val{1}}, differential_vars=trues(size(y₀)))
    @owrenzen3pre1
...
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
    cache::Union{OwrenZen3ConstantCache, OwrenZen3Cache},
    idxs, T::Type{Val{2}}, differential_vars=trues(size(y₀)))
    @owrenzen3pre2
...
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
    cache::Union{OwrenZen3ConstantCache, OwrenZen3Cache},
    idxs, T::Type{Val{3}}, differential_vars=trues(size(y₀)))
    @owrenzen3pre3
...
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
    cache::Union{OwrenZen4ConstantCache, OwrenZen4Cache},
    idxs, T::Type{Val{4}}, differential_vars=trues(size(y₀)))
    @owrenzen4pre4
...
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
    cache::Union{OwrenZen5ConstantCache, OwrenZen5Cache},
    idxs::Nothing, T::Type{Val{5}}, differential_vars=trues(size(y₀)))
    @owrenzen5pre5
...
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
    cache::Union{OwrenZen5ConstantCache, OwrenZen5Cache},
    idxs, T::Type{Val{5}}, differential_vars=trues(size(y₀)))
    @owrenzen5pre5
