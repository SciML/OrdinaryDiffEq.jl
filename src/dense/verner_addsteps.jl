...
"""
@muladd @inline function ode_addsteps!(k,t,uprev,u,dt,f,p,cache::Vern6Cache,always_calc_begin = false,allow_calc_end = true,force_calc_end = false)
...
"""
@muladd @inline function ode_addsteps!(k,t,uprev,u,dt,f,p,cache::Vern7Cache,always_calc_begin = false,allow_calc_end = true,force_calc_end = false)
...
"""
@muladd @inline function ode_addsteps!(k,t,uprev,u,dt,f,p,cache::Vern8Cache,always_calc_begin = false,allow_calc_end = true,force_calc_end = false)
...
"""
@muladd @inline function ode_addsteps!(k,t,uprev,u,dt,f,p,cache::Vern9Cache,always_calc_begin = false,allow_calc_end = true,force_calc_end = false)
...
"""
@muladd @inline function ode_addsteps!(k,t,uprev,u,dt,f,p,cache::Vern6ConstantCache,always_calc_begin = false,allow_calc_end = true,force_calc_end = false)
  if length(k) < 9 || always_calc_begin
...
"""
@muladd @inline function ode_addsteps!(k,t,uprev,u,dt,f,p,cache::Vern7ConstantCache,always_calc_begin = false,allow_calc_end = true,force_calc_end = false)
  if length(k) < 10 || always_calc_begin
...
"""
@muladd @inline function ode_addsteps!(k,t,uprev,u,dt,f,p,cache::Vern8ConstantCache,always_calc_begin = false,allow_calc_end = true,force_calc_end = false)
  if length(k) <13 || always_calc_begin
...
"""
@muladd @inline function ode_addsteps!(k,t,uprev,u,dt,f,p,cache::Vern9ConstantCache,always_calc_begin = false,allow_calc_end = true,force_calc_end = false)
  if (length(k) < 16 || always_calc_begin) || ((allow_calc_end && length(k)< 26) || force_calc_end)
  end
  if length(k) < 16 || always_calc_begin
