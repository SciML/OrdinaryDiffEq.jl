@cache struct SSPRK22Cache{uType,rateType,StageLimiter,StepLimiter,Thread} <: OrdinaryDiffEqMutableCache
  u::uType
  uprev::uType
  k::rateType
  fsalfirst::rateType
...
@cache struct SSPRK33Cache{uType,rateType,StageLimiter,StepLimiter,Thread} <: OrdinaryDiffEqMutableCache
  u::uType
  uprev::uType
  k::rateType
  fsalfirst::rateType
...
function alg_cache(alg::SSPRK53,u,rate_prototype,::Type{uEltypeNoUnits},::Type{uBottomEltypeNoUnits},::Type{tTypeNoUnits},uprev,uprev2,f,t,dt,reltol,p,calck,::Val{true}) where {uEltypeNoUnits,uBottomEltypeNoUnits,tTypeNoUnits}
  ...
  SSPRK53Cache(u,uprev,k,fsalfirst,tmp,tab,alg.stage_limiter!,alg.step_limiter!,alg.thread)
end
...
@cache struct SSPRK53_2N1Cache{uType,rateType,TabType,StageLimiter,StepLimiter,Thread} <: OrdinaryDiffEqMutableCache
  u::uType
  uprev::uType
  k::rateType
  fsalfirst::rateType
...
function alg_cache(alg::SSPRK53_2N1,u,rate_prototype,::Type{uEltypeNoUnits},::Type{uBottomEltypeNoUnits},::Type{tTypeNoUnits},uprev,uprev2,f,t,dt,reltol,p,calck,::Val{true}) where {uEltypeNoUnits,uBottomEltypeNoUnits,tTypeNoUnits}
  ...
  SSPRK53_2N1Cache(u,uprev,k,fsalfirst,tab,alg.stage_limiter!,alg.step_limiter!,alg.thread)
end
...
@cache struct SSPRK53_2N2Cache{uType,rateType,TabType,StageLimiter,StepLimiter,Thread} <: OrdinaryDiffEqMutableCache
  u::uType
  uprev::uType
  k::rateType
  fsalfirst::rateType
...
function alg_cache(alg::SSPRK53_2N2,u,rate_prototype,::Type{uEltypeNoUnits},::Type{uBottomEltypeNoUnits},::Type{tTypeNoUnits},uprev,uprev2,f,t,dt,reltol,p,calck,::Val{true}) where {uEltypeNoUnits,uBottomEltypeNoUnits,tTypeNoUnits}
  ...
  SSPRK53_2N2Cache(u,uprev,k,fsalfirst,tab,alg.stage_limiter!,alg.step_limiter!,alg.thread)
end
...
@cache struct SSPRK53_HCache{uType,rateType,TabType,StageLimiter,StepLimiter,Thread} <: OrdinaryDiffEqMutableCache
  u::uType
  uprev::uType
  k::rateType
  fsalfirst::rateType
...
function alg_cache(alg::SSPRK53_H,u,rate_prototype,::Type{uEltypeNoUnits},::Type{uBottomEltypeNoUnits},::Type{tTypeNoUnits},uprev,uprev2,f,t,dt,reltol,p,calck,::Val{true}) where {uEltypeNoUnits,uBottomEltypeNoUnits,tTypeNoUnits}
  ...
  SSPRK53_HCache(u,uprev,k,fsalfirst,tmp,tab,alg.stage_limiter!,alg.step_limiter!,alg.thread)
end
...
@cache struct SSPRK63Cache{uType,rateType,TabType,StageLimiter,StepLimiter,Thread} <: OrdinaryDiffEqMutableCache
  u::uType
  uprev::uType
  k::rateType
  fsalfirst::rateType
...
function alg_cache(alg::SSPRK63,u,rate_prototype,::Type{uEltypeNoUnits},::Type{uBottomEltypeNoUnits},::Type{tTypeNoUnits},uprev,uprev2,f,t,dt,reltol,p,calck,::Val{true}) where {uEltypeNoUnits,uBottomEltypeNoUnits,tTypeNoUnits}
  ...
  SSPRK63Cache(u,uprev,k,fsalfirst,tmp,u₂,tab,alg.stage_limiter!,alg.step_limiter!,alg.thread)
end
...
@cache struct SSPRK73Cache{uType,rateType,TabType,StageLimiter,StepLimiter,Thread} <: OrdinaryDiffEqMutableCache
  u::uType
  uprev::uType
  k::rateType
  fsalfirst::rateType
...
function alg_cache(alg::SSPRK73,u,rate_prototype,::Type{uEltypeNoUnits},::Type{uBottomEltypeNoUnits},::Type{tTypeNoUnits},uprev,uprev2,f,t,dt,reltol,p,calck,::Val{true}) where {uEltypeNoUnits,uBottomEltypeNoUnits,tTypeNoUnits}
  ...
  SSPRK73Cache(u,uprev,k,fsalfirst,tmp,u₁,tab,alg.stage_limiter!,alg.step_limiter!,alg.thread)
end
...
@cache struct SSPRK83Cache{uType,rateType,TabType,StageLimiter,StepLimiter,Thread} <: OrdinaryDiffEqMutableCache
  u::uType
  uprev::uType
  k::rateType
  fsalfirst::rateType
...
function alg_cache(alg::SSPRK83,u,rate_prototype,::Type{uEltypeNoUnits},::Type{uBottomEltypeNoUnits},::Type{tTypeNoUnits},uprev,uprev2,f,t,dt,reltol,p,calck,::Val{true}) where {uEltypeNoUnits,uBottomEltypeNoUnits,tTypeNoUnits}
  ...
  SSPRK83Cache(u,uprev,k,fsalfirst,tmp,u₂,u₃,tab,alg.stage_limiter!,alg.step_limiter!,alg.thread)
end
...
@cache struct SSPRK43Cache{uType,rateType,uNoUnitsType,TabType,StageLimiter,StepLimiter,Thread} <: OrdinaryDiffEqMutableCache
  u::uType
  uprev::uType
  k::rateType
  fsalfirst::rateType
...
@cache struct SSPRK432Cache{uType,rateType,uNoUnitsType,StageLimiter,StepLimiter,Thread} <: OrdinaryDiffEqMutableCache
  u::uType
  uprev::uType
  k::rateType
  fsalfirst::rateType
...
@cache struct SSPRK932Cache{uType,rateType,uNoUnitsType,StageLimiter,StepLimiter,Thread} <: OrdinaryDiffEqMutableCache
  u::uType
  uprev::uType
  k::rateType
  fsalfirst::rateType
...
@cache struct SSPRK54Cache{uType,rateType,TabType,StageLimiter,StepLimiter,Thread} <: OrdinaryDiffEqMutableCache
  u::uType
  uprev::uType
  k::rateType
  fsalfirst::rateType
...
function alg_cache(alg::SSPRK54,u,rate_prototype,::Type{uEltypeNoUnits},::Type{uBottomEltypeNoUnits},::Type{tTypeNoUnits},uprev,uprev2,f,t,dt,reltol,p,calck,::Val{true}) where {uEltypeNoUnits,uBottomEltypeNoUnits,tTypeNoUnits}
  ...
  SSPRK54Cache(u,uprev,k,fsalfirst,k₃,u₂,u₃,tmp,tab,alg.stage_limiter!,alg.step_limiter!,alg.thread)
end
...
@cache struct SSPRK104Cache{uType,rateType,StageLimiter,StepLimiter,Thread} <: OrdinaryDiffEqMutableCache
  u::uType
  uprev::uType
  k::rateType
  fsalfirst::rateType
...
function alg_cache(alg::SSPRK104,u,rate_prototype,::Type{uEltypeNoUnits},::Type{uBottomEltypeNoUnits},::Type{tTypeNoUnits},uprev,uprev2,f,t,dt,reltol,p,calck,::Val{true}) where {uEltypeNoUnits,uBottomEltypeNoUnits,tTypeNoUnits}
  ...
  k₄ = zero(rate_prototype)
  SSPRK104Cache(u,uprev,k,fsalfirst,k₄,tmp,alg.stage_limiter!,alg.step_limiter!,alg.thread)
end
