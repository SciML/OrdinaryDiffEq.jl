...
alg_cache(
    ...
    calck,
    ::Val{false},
) where {uEltypeNoUnits,uBottomEltypeNoUnits,tTypeNoUnits} = SSPRK22ConstantCache()
...
alg_cache(
    ...
    calck,
    ::Val{false},
) where {uEltypeNoUnits,uBottomEltypeNoUnits,tTypeNoUnits} = SSPRK33ConstantCache()
...
@cache struct SSPRK53_2N2Cache{uType,rateType,TabType,StageLimiter,StepLimiter,Thread} <:
              OrdinaryDiffEqMutableCache
    u::uType
    uprev::uType
    k::rateType
...
@cache struct SSPRK432Cache{uType,rateType,uNoUnitsType,StageLimiter,StepLimiter,Thread} <:
              OrdinaryDiffEqMutableCache
    u::uType
    uprev::uType
    k::rateType
...
alg_cache(
    ...
    calck,
    ::Val{false},
) where {uEltypeNoUnits,uBottomEltypeNoUnits,tTypeNoUnits} = SSPRK432ConstantCache()
...
@cache mutable struct SSPRKMSVS43Cache{uType,rateType,StageLimiter,StepLimiter} <:
                      OrdinaryDiffEqMutableCache
    u::uType
    uprev::uType
    fsalfirst::rateType
...
@cache struct SSPRK932Cache{uType,rateType,uNoUnitsType,StageLimiter,StepLimiter,Thread} <:
              OrdinaryDiffEqMutableCache
    u::uType
    uprev::uType
    k::rateType
...
alg_cache(
    ...
    calck,
    ::Val{false},
) where {uEltypeNoUnits,uBottomEltypeNoUnits,tTypeNoUnits} = SSPRK932ConstantCache()
...
alg_cache(
    ...
    calck,
    ::Val{false},
) where {uEltypeNoUnits,uBottomEltypeNoUnits,tTypeNoUnits} = SSPRK104ConstantCache()
