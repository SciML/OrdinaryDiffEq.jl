...
function alg_cache(
    ...
    linsolve = init(linprob, alg.linsolve, alias_A = true, alias_b = true, Pl = Pl, Pr = Pr)

    grad_config = build_grad_config(alg, f, tf, du1, t)
    jac_config = build_jac_config(alg, f, uf, du1, uprev, u, tmp, du2, Val(false))
    algebraic_vars =
        f.mass_matrix === I ? nothing : [all(iszero, x) for x in eachcol(f.mass_matrix)]
...
function alg_cache(
    ...
    Rosenbrock33ConstantCache(
        tf,
        uf,
        ROS3PTableau(constvalue(uBottomEltypeNoUnits), constvalue(tTypeNoUnits)),
        J,
        W,
        linsolve,
    )
...
function alg_cache(
    ...
    Rosenbrock34ConstantCache(
        tf,
        uf,
        Rodas3Tableau(constvalue(uBottomEltypeNoUnits), constvalue(tTypeNoUnits)),
        J,
        W,
        linsolve,
    )
...
@cache mutable struct Rodas4Cache{
    uType,
    rateType,
    uNoUnitsType,
    JType,
...
function alg_cache(
    ...
    Rodas4ConstantCache(
        tf,
        uf,
        Rodas4Tableau(constvalue(uBottomEltypeNoUnits), constvalue(tTypeNoUnits)),
        J,
        W,
        linsolve,
        alg_autodiff(alg),
...
function alg_cache(
    ...
    Rodas4ConstantCache(
        tf,
        uf,
        Rodas42Tableau(constvalue(uBottomEltypeNoUnits), constvalue(tTypeNoUnits)),
        J,
        W,
        linsolve,
        alg_autodiff(alg),
...
function alg_cache(
    ...
    Rodas4ConstantCache(
        tf,
        uf,
        Rodas4PTableau(constvalue(uBottomEltypeNoUnits), constvalue(tTypeNoUnits)),
        J,
        W,
        linsolve,
        alg_autodiff(alg),
...
function alg_cache(
    ...
    Rodas4ConstantCache(
        tf,
        uf,
        Rodas4P2Tableau(constvalue(uBottomEltypeNoUnits), constvalue(tTypeNoUnits)),
        J,
        W,
        linsolve,
        alg_autodiff(alg),
...
function alg_cache(
    ...
    Rosenbrock5ConstantCache(
        tf,
        uf,
        Rodas5Tableau(constvalue(uBottomEltypeNoUnits), constvalue(tTypeNoUnits)),
        J,
        W,
        linsolve,
    )
...
function alg_cache(
    ...
    Rosenbrock5ConstantCache(
        tf,
        uf,
        Rodas5PTableau(constvalue(uBottomEltypeNoUnits), constvalue(tTypeNoUnits)),
        J,
        W,
        linsolve,
    )
