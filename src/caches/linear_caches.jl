...
struct MagnusMidpointConstantCache <: OrdinaryDiffEqConstantCache end
...
struct RKMK2ConstantCache <: OrdinaryDiffEqConstantCache end
...
struct LieRK4ConstantCache <: OrdinaryDiffEqConstantCache end
...
struct CG3ConstantCache <: OrdinaryDiffEqConstantCache end
...
struct CG2ConstantCache <: OrdinaryDiffEqConstantCache end
...
struct MagnusAdapt4ConstantCache <: OrdinaryDiffEqConstantCache end
...
struct MagnusNC8ConstantCache <: OrdinaryDiffEqConstantCache end
...
struct MagnusGL4ConstantCache <: OrdinaryDiffEqConstantCache end
...
struct MagnusGL8ConstantCache <: OrdinaryDiffEqConstantCache end
...
struct MagnusNC6ConstantCache <: OrdinaryDiffEqConstantCache end
...
struct MagnusGL6ConstantCache <: OrdinaryDiffEqConstantCache end
...
struct MagnusGauss4ConstantCache <: OrdinaryDiffEqConstantCache end
...
struct CayleyEulerConstantCache <: OrdinaryDiffEqConstantCache end
...
alg_cache(
    ...
    calck,
    ::Val{false},
) where {uEltypeNoUnits,uBottomEltypeNoUnits,tTypeNoUnits} = CayleyEulerConstantCache()
...
struct MagnusLeapfrogConstantCache <: OrdinaryDiffEqConstantCache end
...
function alg_cache(
    ...
    elseif alg.krylov == :adaptive
        ...
        throw(
            ArgumentError(
                "Unknown krylov setting $(alg.krylov). Can be :off, :simple or :adaptive.",
            ),
        )
    end
