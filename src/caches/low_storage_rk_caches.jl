...
@cache struct ParsaniKetchesonDeconinck3S205Cache{uType,rateType,TabType} <: OrdinaryDiffEqMutableCache
  u::uType
  uprev::uType
  k::rateType
  tmp::uType
...
struct ParsaniKetchesonDeconinck3S205ConstantCache{T,T2} <: OrdinaryDiffEqConstantCache
  γ12end::SVector{19,T} # γ11 is always zero
  γ22end::SVector{19,T} # γ21 is always one
  γ32end::SVector{19,T} # γ31 is always zero
  δ2end ::SVector{19,T} # δ1  is always one
  β1::T
  β2end::SVector{19,T}
  c2end::SVector{19,T2} # c1 is always zero

  function ParsaniKetchesonDeconinck3S205ConstantCache(::Type{T}, ::Type{T2}) where {T,T2}
    γ102 = T(-1.1682479703229380e+0)
    γ103 = T(-2.5112155037089772e+0)
    γ104 = T(-5.5259960154735988e-1)
    γ105 = T(2.9243033509511740e-3)
    γ106 = T(-4.7948973385386493e+0)
    γ107 = T(-5.3095533497183016e+0)
    γ108 = T(-2.3624194456630736e+0)
    γ109 = T(2.0068995756589547e-1)
    γ110 = T(-1.4985808661597710e+0)
    γ111 = T(4.8941228502377687e-1)
    γ112 = T(-1.0387512755259576e-1)
    γ113 = T(-1.3287664273288191e-1)
    γ114 = T(7.5858678822837511e-1)
    γ115 = T(-4.3321586294096939e+0)
    γ116 = T(4.8199700138402146e-1)
    γ117 = T(-7.0924756614960671e-3)
    γ118 = T(-8.8422252029506054e-1)
    γ119 = T(-8.9129367099545231e-1)
    γ120 = T(1.5297157134040762e+0)
    γ12end = SVector(γ102, γ103, γ104, γ105, γ106, γ107, γ108, γ109, γ110, γ111, γ112, γ113, γ114, γ115, γ116, γ117, γ118, γ119, γ120)

    γ202 = T(8.8952052154583572e-1)
    γ203 = T(8.8988129100385194e-1)
    γ204 = T(3.5701564494677057e-1)
    γ205 = T(2.4232462479216824e-1)
    γ206 = T(1.2727083024258155e+0)
    γ207 = T(1.1126977210342681e+0)
    γ208 = T(5.1360709645409097e-1)
    γ209 = T(1.1181089682044856e-1)
    γ210 = T(2.7881272382085232e-1)
    γ211 = T(4.9032886260666715e-2)
    γ212 = T(4.1871051065897870e-2)
    γ213 = T(4.4602463796686219e-2)
    γ214 = T(1.4897271251154750e-2)
    γ215 = T(2.6244269699436817e-1)
    γ216 = T(-4.7486056986590294e-3)
    γ217 = T(2.3219312682036197e-2)
    γ218 = T(6.2852588972458059e-2)
    γ219 = T(5.4473719351268962e-2)
    γ220 = T(2.4345446089014514e-2)
    γ22end = SVector(γ202, γ203, γ204, γ205, γ206, γ207, γ208, γ209, γ210, γ211, γ212, γ213, γ214, γ215, γ216, γ217, γ218, γ219, γ220)

    γ302 = T(0.0000000000000000e+0)
    γ303 = T(0.0000000000000000e+0)
    γ304 = T(1.9595487007932735e-1)
    γ305 = T(-6.9871675039100595e-5)
    γ306 = T(1.0592231169810050e-1)
    γ307 = T(1.0730426871909635e+0)
    γ308 = T(8.9257826744389124e-1)
    γ309 = T(-1.4078912484894415e-1)
    γ310 = T(-2.6869890558434262e-1)
    γ311 = T(-6.5175753568318007e-2)
    γ312 = T(4.9177812903108553e-1)
    γ313 = T(4.6017684776493678e-1)
    γ314 = T(-6.4689512947008251e-3)
    γ315 = T(4.4034728024115377e-1)
    γ316 = T(6.1086885767527943e-1)
    γ317 = T(5.0546454457410162e-1)
    γ318 = T(5.4668509293072887e-1)
    γ319 = T(7.1414182420995431e-1)
    γ320 = T(-1.0558095282893749e+0)
    γ32end = SVector(γ302, γ303, γ304, γ305, γ306, γ307, γ308, γ309, γ310, γ311, γ312, γ313, γ314, γ315, γ316, γ317, γ318, γ319, γ320)

    δ02 = T(1.4375468781258596e+0)
    δ03 = T(1.5081653637261594e+0)
    δ04 = T(-1.4575347066062688e-1)
    δ05 = T(3.1495761082838158e-1)
    δ06 = T(3.5505919368536931e-1)
    δ07 = T(2.3616389374566960e-1)
    δ08 = T(1.0267488547302055e-1)
    δ09 = T(3.5991243524519438e+0)
    δ10 = T(1.5172890003890782e+0)
    δ11 = T(1.8171662741779953e+0)
    δ12 = T(2.8762263521436831e+0)
    δ13 = T(4.6350154228218754e-1)
    δ14 = T(1.5573122110727220e+0)
    δ15 = T(2.0001066778080254e+0)
    δ16 = T(9.1690694855534305e-1)
    δ17 = T(2.0474618401365854e+0)
    δ18 = T(-3.2336329115436924e-1)
    δ19 = T(3.2899060754742177e-1)
    δ20 = T(0.0000000000000000e+0)
    δ2end = SVector(δ02, δ03, δ04, δ05, δ06, δ07, δ08, δ09, δ10, δ11, δ12, δ13, δ14, δ15, δ16, δ17, δ18, δ19, δ20)

    β1 = T(1.7342385375780556e-1)
    β02 = T(2.8569004728564801e-1)
    β03 = T(6.8727044379779589e-1)
    β04 = T(1.2812121060977319e-1)
    β05 = T(4.9137180740403122e-4)
    β06 = T(4.7033584446956857e-2)
    β07 = T(4.4539998128170821e-1)
    β08 = T(1.2259824887343720e+0)
    β09 = T(2.0616463985024421e-2)
    β10 = T(1.5941162575324802e-1)
    β11 = T(1.2953803678226099e+0)
    β12 = T(1.7287352967302603e-3)
    β13 = T(1.1660483420536467e-1)
    β14 = T(7.7997036621815521e-2)
    β15 = T(3.2563250234418012e-1)
    β16 = T(1.0611520488333197e+0)
    β17 = T(6.5891625628040993e-4)
    β18 = T(8.3534647700054046e-2)
    β19 = T(9.8972579458252483e-2)
    β20 = T(4.3010116145097040e-2)
    β2end = SVector(β02, β03, β04, β05, β06, β07, β08, β09, β10, β11, β12, β13, β14, β15, β16, β17, β18, β19, β20)

    c02 = T2(1.7342385375780556e-1)
    c03 = T2(3.0484982420032158e-1)
    c04 = T2(5.5271395645729193e-1)
    c05 = T2(4.7079204549750037e-2)
    c06 = T2(1.5652540451324129e-1)
    c07 = T2(1.8602224049074517e-1)
    c08 = T2(2.8426620035751449e-1)
    c09 = T2(9.5094727548792268e-1)
    c10 = T2(6.8046501070096010e-1)
    c11 = T2(5.9705366562360063e-1)
    c12 = T2(1.8970821645077285e+0)
    c13 = T2(2.9742664004529606e-1)
    c14 = T2(6.0813463700134940e-1)
    c15 = T2(7.3080004188477765e-1)
    c16 = T2(9.1656999044951792e-1)
    c17 = T2(1.4309687554614530e+0)
    c18 = T2(4.1043824968249148e-1)
    c19 = T2(8.4898255952298962e-1)
    c20 = T2(3.3543896258348421e-1)
...
function alg_cache(alg::ParsaniKetchesonDeconinck3S205,u,rate_prototype,uEltypeNoUnits,uBottomEltypeNoUnits,tTypeNoUnits,uprev,uprev2,f,t,dt,reltol,p,calck,::Type{Val{true}})
  ...
  ParsaniKetchesonDeconinck3S205Cache(u,uprev,k,tmp,fsalfirst,tab)
end
