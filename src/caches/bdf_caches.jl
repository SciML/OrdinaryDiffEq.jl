...
function alg_cache(alg::SBDF, u, rate_prototype, ::Type{uEltypeNoUnits},
    ...
    SBDFCache(1, alg.ark, u, uprev, fsalfirst, nlsolver, uprev2, uprev3, uprev4, k₁, k₂, k₃,
              du₁, du₂)
end

# QNDF1

@cache mutable struct QNDF1ConstantCache{N, coefType, coefType1, coefType2, dtType, uType
                                         } <: OrdinaryDiffEqConstantCache
    nlsolver::N
    D::coefType1
    D2::coefType2
...
@cache mutable struct QNDF2ConstantCache{N, coefType, coefType1, coefType2, uType, dtType
                                         } <: OrdinaryDiffEqConstantCache
    nlsolver::N
    D::coefType1
    D2::coefType2
...
@cache mutable struct QNDFConstantCache{MO, N, coefType, UType, dtType, EEstType, gammaType
                                        } <: OrdinaryDiffEqConstantCache
    nlsolver::N
    U::UType
    D::coefType
...
@cache mutable struct FBDFCache{MO, N, rateType, uNoUnitsType, tsType, tType, uType, uuType,
