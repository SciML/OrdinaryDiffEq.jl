...
# @cache mutable struct VTSRKCache{uType,rateType,Tab} <: OrdinaryDiffEqMutableCache
#   u::uType
#   uprev::uType
#   uprev2::uType
#   fsalfirst::rateType
...
# end
#
# @cache mutable struct VTSRKConstantCache{rateType,Tab} <: OrdinaryDiffEqConstantCache
#   u::uType
#   uprev::uType
#   uprev2::uType
#   fsalfirst::rateType
...
#   tab = VTSRKTableau(real(uBottomEltypeNoUnits),real(tTypeNoUnits))
#   fsalfirst = zero(rate_prototype)
#   k0 = similar(u)
#   k1 = similar(u)
#   k2 = similar(u)
...
#   k  = similar(u)
#   tmp = similar(u)
#   VTSRKCache(u,uprev,fsalfirst,k0,k1,k2,k3,k4,k5,k6,k7,k8,k,tmp,1,tab)
# end
#
...
#   k  = similar(u)
#   tmp = similar(u)
#   VTSRKConstantCache(u,uprev,fsalfirst,k0,k1,k2,k3,k4,k5,k6,k7,k8,k,tmp,1,tab)
# end
