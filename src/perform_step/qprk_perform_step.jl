...
@muladd function perform_step!(integrator,::QPRK98ConstantCache, repeat_step=false)
    ...
    k10 = f(uprev + dt * (b10_1 * k1 + b10_6 * k6 + b10_7 * k7 + b10_8 * k8 + b10_9 * k9), p, t + d10 * dt)
    k11 = f(uprev + dt * (b11_1 * k1 + b11_6 * k6 + b11_7 * k7 + b11_8 * k8 + b11_9 * k9 + b11_10 * k10), p, t + d11 * dt)
    k12 = f(uprev + dt * (b12_1 * k1 + b12_6 * k6 + b12_7 * k7 + b12_8 * k8 + b12_9 * k9 + b12_10 * k10 + b12_11 * k11), p, t + d12 * dt)
    k13 = f(uprev + dt * (b13_1 * k1 + b13_6 * k6 + b13_7 * k7 + b13_8 * k8 + b13_9 * k9 + b13_10 * k10 + b13_11 * k11 + b13_12 * k12), p, t + d13 * dt)
    ...
    if integrator.opts.adaptive
        utilde = dt * (ϵ1 * k1 + ϵ8 * k8 + ϵ9 * k9 + ϵ10 * k10 + ϵ11 * k11 + ϵ12 * k12 + ϵ13 * k13 + ϵ14 * k14 + ϵ15 * k15)
...
@muladd function perform_step!(integrator, cache::QPRK98Cache, repeat_step=false)
    ...
    f(k6, tmp, p, t + d6 * dt)
    @.. broadcast=false thread=thread tmp = uprev + dt * (b71 * k1 + b74 * k4 + b75 * k5 + b76 * k6)
    ...
    f(k8, tmp, p, t + d8 * dt)
    @.. broadcast=false thread=thread tmp = uprev + dt * (b91 * k1 + b96 * k6 + b97 * k7 + b98 * k8)
    stage_limiter!(tmp, integrator, p, t + d9 * dt)
    f(k9, tmp, p, t + d9 * dt)
    @.. broadcast=false thread=thread tmp = uprev + dt * (b10_1 * k1 + b10_6 * k6 + b10_7 * k7 + b10_8 * k8 + b10_9 * k9)
    ...
    @.. broadcast=false thread=thread tmp = uprev + dt * (b12_1 * k1 + b12_6 * k6 + b12_7 * k7 + b12_8 * k8 + b12_9 * k9 + b12_10 * k10 + b12_11 * k11)
    stage_limiter!(tmp, integrator, p, t + d12 * dt)
    f(k12, tmp, p, t + d12 * dt)
    @.. broadcast=false thread=thread tmp = uprev + dt * (b13_1 * k1 + b13_6 * k6 + b13_7 * k7 + b13_8 * k8 + b13_9 * k9 + b13_10 * k10 + b13_11 * k11 + b13_12 * k12)
    stage_limiter!(tmp, integrator, p, t + d13 * dt)
    f(k13, tmp, p, t + d13 * dt)
    @.. broadcast=false thread=thread tmp = uprev + dt * (b14_1 * k1 + b14_6 * k6 + b14_7 * k7 + b14_8 * k8 + b14_9 * k9 + b14_10 * k10 + b14_11 * k11 + b14_12 * k12 + b14_13 * k13)
    stage_limiter!(tmp, integrator, p, t + d14 * dt)
    f(k14, tmp, p, t + d14 * dt)
    @.. broadcast=false thread=thread tmp = uprev + dt * (b15_1 * k1 + b15_6 * k6 + b15_7 * k7 + b15_8 * k8 + b15_9 * k9 + b15_10 * k10 + b15_11 * k11 + b15_12 * k12 + b15_13 * k13 + b15_14 * k14)
    stage_limiter!(tmp, integrator, p, t + dt)
    f(k15, tmp, p, t + dt)
    @.. broadcast=false thread=thread tmp = uprev + dt * (b16_1 * k1 + b16_6 * k6 + b16_7 * k7 + b16_8 * k8 + b16_9 * k9 + b16_10 * k10 + b16_11 * k11 + b16_12 * k12 + b16_13 * k13 + b16_14 * k14)
