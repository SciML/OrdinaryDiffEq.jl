...
@muladd function perform_step!(
    integrator,
    cache::Feagin10ConstantCache,
    repeat_step = false,
)
    @unpack t, dt, uprev, u, f, p = integrator
    @unpack adaptiveConst,
    a0100,
    a0200,
    a0201,
    a0300,
    ...
    k11 = f(
        uprev +
        dt * (a1000 * k1 + a1005 * k6 + a1006 * k7 + a1007 * k8 + a1008 * k9 + a1009 * k10),
        p,
        t + c10 * dt,
    )
    k12 = f(
...
@muladd function perform_step!(integrator, cache::Feagin10Cache, repeat_step = false)
    ...
    @tight_loop_macros for i in uidx
        @inbounds tmp[i] =
            uprev[i] + dt * (a0600 * k1[i] + a0603 * k4[i] + a0604 * k5[i] + a0605 * k6[i])
    end
    f(k7, tmp, p, t + c6 * dt)
    @tight_loop_macros for i in uidx
        @inbounds tmp[i] =
            uprev[i] + dt * (a0700 * k1[i] + a0704 * k5[i] + a0705 * k6[i] + a0706 * k7[i])
    end
    f(k8, tmp, p, t + c7 * dt)
    @tight_loop_macros for i in uidx
        @inbounds tmp[i] =
            uprev[i] + dt * (a0800 * k1[i] + a0805 * k6[i] + a0806 * k7[i] + a0807 * k8[i])
    end
    f(k9, tmp, p, t + c8 * dt)
    @tight_loop_macros for i in uidx
        @inbounds tmp[i] =
            uprev[i] +
            dt *
            (a0900 * k1[i] + a0905 * k6[i] + a0906 * k7[i] + a0907 * k8[i] + a0908 * k9[i])
    end
    f(k10, tmp, p, t + c9 * dt)
    @tight_loop_macros for i in uidx
        @inbounds tmp[i] =
...
@muladd function perform_step!(
    ...
    k13 = f(
        uprev + dt * (a1200 * k1 + a1208 * k9 + a1209 * k10 + a1210 * k11 + a1211 * k12),
        p,
        t + c12 * dt,
    )
    k14 = f(
        uprev +
        dt * (
            a1300 * k1 + a1308 * k9 + a1309 * k10 + a1310 * k11 + a1311 * k12 + a1312 * k13
        ),
        p,
        t + c13 * dt,
    )
    ...
    @tight_loop_macros for i in uidx
        @inbounds tmp[i] =
            ...
            dt * (
                ...
                (a1610 * k11[i] + a1611 * k12[i] + a1612 * k13[i] + a1613 * k14[i]) +
    ...
    @tight_loop_macros for i in uidx
        @inbounds tmp[i] =
            ...
            dt * (
                ...
                (a1707 * k8[i] + a1708 * k9[i] + a1709 * k10[i] + a1710 * k11[i]) +
                (a1711 * k12[i] + a1712 * k13[i] + a1713 * k14[i] + a1714 * k15[i]) +
    ...
    @tight_loop_macros for i in uidx
        @inbounds tmp[i] =
            ...
            dt * (
                ...
                (a1807 * k8[i] + a1808 * k9[i] + a1809 * k10[i] + a1810 * k11[i]) +
                (a1811 * k12[i] + a1812 * k13[i] + a1813 * k14[i] + a1814 * k15[i]) +
    ...
    @tight_loop_macros for i in uidx
        @inbounds tmp[i] =
            ...
            dt * (
                ...
                (a1906 * k7[i] + a1908 * k9[i] + a1909 * k10[i] + a1910 * k11[i]) +
                (a1911 * k12[i] + a1912 * k13[i] + a1913 * k14[i] + a1914 * k15[i]) +
                (a1915 * k16[i] + a1916 * k17[i] + a1917 * k18[i] + a1918 * k19[i])
            )
    end
    f(k20, tmp, p, t + c19 * dt)
    @tight_loop_macros for i in uidx
        @inbounds tmp[i] =
            ...
            dt * (
                ...
                (a2005 * k6[i] + a2007 * k8[i] + a2009 * k10[i] + a2010 * k11[i]) +
    ...
    @tight_loop_macros for i in uidx
        @inbounds tmp[i] =
            ...
            dt * (
                ...
                (a2106 * k7[i] + a2107 * k8[i] + a2109 * k10[i] + a2110 * k11[i]) +
                (a2117 * k18[i] + a2118 * k19[i] + a2119 * k20[i] + a2120 * k21[i])
            )
    end
    f(k22, tmp, p, t + c21 * dt)
    @tight_loop_macros for i in uidx
    ...
    @tight_loop_macros for i in uidx
        @inbounds tmp[i] =
            ...
            dt * (
                ...
                (a2409 * k10[i] + a2410 * k11[i] + a2411 * k12[i] + a2412 * k13[i]) +
                (a2413 * k14[i] + a2414 * k15[i] + a2415 * k16[i] + a2416 * k17[i]) +
                (a2417 * k18[i] + a2418 * k19[i] + a2419 * k20[i] + a2420 * k21[i]) +
