...
@muladd function perform_step!(integrator, cache::PFRK87ConstantCache, repeat_step=false)
  ...
  k13= f(uprev+dt*(α1301*k1                +α1304*k4+α1305*k5+α1306*k6+α1307*k7+α1308*k8+α1309*k9+α1310*k10), p, t+c13*dt)
  integrator.destats.nf += 12
  u = uprev + dt*(β1*k1+β6*k6+β7*k7+β8*k8+β9*k9+β10*k10+β11*k11+β12*k12+β13*k12)
  if integrator.opts.adaptive
...
@muladd function perform_step!(integrator, cache::PFRK87Cache, repeat_step=false)
  ...
  @.. tmp = uprev+dt*(α1301*k1+α1304*k4+α1305*k5+α1306*k6+α1307*k7+α1308*k8+α1309*k9+α1310*k10)
  f(k13, tmp, p, t+c13*dt)
  @.. u = uprev + dt*(β1*k1+β6*k6+β7*k7+β8*k8+β9*k9+β10*k10+β11*k11+β12*k12++β13*k13)
  integrator.destats.nf += 13
  if integrator.opts.adaptive
    @.. utilde = dt*(β1tilde*k1 + β6tilde*k6 + β7tilde*k7 + β8tilde*k8 + β9tilde*k9 + β10tilde*k10 + β11tilde*k11 + βtilde12*k12)
    calculate_residuals!(atmp, utilde, uprev, u, integrator.opts.abstol, integrator.opts.reltol,integrator.opts.internalnorm,t)
    integrator.EEst = integrator.opts.internalnorm(atmp,t)
  end
  f(k, u, p, t+dt)
