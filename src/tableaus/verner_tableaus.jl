...
function Vern6ExtraStages(T, T2)
    ...
    a1109 = convert(
        T,
        -426178927623072052719640507155669 // 11712038417736656029207275390625000,
    )
    ...
    a1211 =
        convert(T, -3194830887993202085244614477336220 // 678662636676110315314332975245759)
...
function Vern6InterpolationCoefficients(T::Type{<:CompiledFloats})
    ...
    Vern6InterpolationCoefficients(
        r011,
        r012,
        r013,
        r014,
...
function Vern6Tableau(T, T2)
    ...
    a75 =
        convert(T, 2771826790140332140865242520369241 // 396438716042723436917079980147600)
    ...
    a83 = convert(
        T,
        818622075710363565982285196611368750 // 3936576237903728151856072395343129,
    )
    a84 = convert(
        T,
...
function Vern7InterpolationCoefficients(T::Type{<:CompiledFloats})
    ...
    Vern7InterpolationCoefficients(
        r011,
        r012,
        r013,
        r014,
...
function Vern7Tableau(T, T2)
    ...
    a096 = convert(
        T,
        BigInt(273847823027445129865693702689010278588244606493753883568739168819449761) // BigInt(
    ...
    a098 = convert(
        T,
        -19705319055289176355560129234220800 // 72595753317320295604316217197876507,
    )
    a101 =
        convert(T, -511858190895337044664743508805671 // 11367030248263048398341724647960)
...
function Vern8Tableau(T, T2)
    ...
    a0908 = convert(
        T,
        BigInt(10332848184452015604056836767286656859124007796970668046446015775000000) // BigInt(
    ...
    a1008 =
        convert(T, 212083202434519082281842245535894 // 20022426044775672563822865371173879)
    a1009 = convert(
        T,
        -BigInt(
    ...
    btilde9 = convert(
        T,
        BigInt(
            17426957952517932078050241885889670195876481434157580946550703126433816616672116622859678756257765,
        ) // BigInt(
...
function Vern9InterpolationCoefficients(T::Type{<:CompiledFloats})
    ...
    Vern9InterpolationCoefficients(
        r011,
        r012,
        r013,
        r014,
...
function Vern9Tableau(T, T2)
    ...
    a0906 = convert(
        T,
        BigInt(22833) // BigInt(102400) + BigInt(8901) // BigInt(204800) * 6^(1 // 2),
    )
    a0907 = convert(
        T,
        BigInt(22833) // BigInt(102400) - BigInt(8901) // BigInt(204800) * 6^(1 // 2),
    ...
    a1301 = convert(
        T,
        -BigInt(56042772675322042139227629978042586330633622706053363946766144416933631) // BigInt(
    ...
    a1309 = convert(
        T,
        BigInt(885774233856672590222951867695327816457340130391639153070521335485617578) // BigInt(
    ...
    btilde1 = convert(
        T,
        -1503069970302555747713611212548875 // 280528789692042930083638923564382764,
    )
    btilde8 = convert(
        T,
    ...
    btilde11 = convert(
        T,
        -6012279881210222990854444850195500 // 209684639122339601934631113492763467,
    )
    btilde12 = convert(
        T,
        BigInt(
            48130484160351526969737032053650002390763871764386160830857331738750104951318921056416737791402447075630390197043182920376678624912056972204118525928289962576625,
        ) // BigInt(
            18335424945568186510119112664132550125302572359250963152570483293379027423802340733168051584642377993876771160601231185777060296929074877769939280988393296194804,
        ),
    )
    btilde13 = convert(
        T,
    ...
    btilde16 =
        convert(T, -1839190071060649887127895100784 // 38045139523510634351420875415397)
