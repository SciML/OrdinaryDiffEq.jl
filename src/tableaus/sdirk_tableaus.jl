...
function ESDIRK659L2SATableau(T, T2)
    ...
    a41 = convert(T, 37633260247889 // 45511413219805)
    ...
    btilde4 = convert(T, 3176520686137389 // 1064235527052079)
    btilde5 = convert(T, -574817982095666 // 1374329821545869)
    btilde6 = convert(T, -507643245828272 // 1001056758847831)
    btilde7 = convert(T, 2013538191006793 // 972919262949000)
    btilde8 = convert(T, 352681731710820 // 726444701718347)
    btilde9 = convert(T, -12107714797721 // 746708658438760)
