...
function KenCarp47Tableau(T,T2)
  ...
  btilde3 = convert(T,BigInt(216367897668138065439709)//BigInt(153341716340757627089664345)) # bhat3-a73
  btilde4 = -convert(T,BigInt(1719969231640509698414113)//BigInt(303097339249411872572263321)) # bhat4-a74
  btilde5 = convert(T,BigInt(33321949854538424751892)//BigInt(16748125370719759490730723)) # bhat5-a75
  btilde6 = convert(T,BigInt(4033362550194444079469)//BigInt(1083063207508329376479196)) # bhat6-a76
  ...
  #TODO():Convert These values for this Method
  α21 = convert(T,2) # c2/γ
