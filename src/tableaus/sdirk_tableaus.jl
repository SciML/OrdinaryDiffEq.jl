...
function KenCarp58Tableau(T,T2)
  ...
  btilde3 = -convert(T,BigInt(18652552508630163520943320)//BigInt(168134443655105334713783643)) # bhat3-a83
  btilde4 = convert(T,BigInt(141161430501477620145807)//BigInt(319735394533244397237135736)) # bhat4-a84
  btilde5 = -convert(T,BigInt(207757214437709595456056)//BigInt(72283007456311581445415925)) # bhat5-a85
  btilde6 = convert(T,BigInt(13674542533282477231637762)//BigInt(149163814411398370516486131)) # bhat6-a86
  btilde7 = convert(T,BigInt(11939168497868428048898551)//BigInt(210101209758476969753215083)) # bhat7-a87
  ...
  ebtilde3 = -convert(T,BigInt(18652552508630163520943320)//BigInt(168134443655105334713783643))#bhat3-eb3
  ebtilde4 = convert(T,BigInt(141161430501477620145807)//BigInt(319735394533244397237135736)) #bhat4-eb4
  ebtilde5 = -convert(T,BigInt(207757214437709595456056)//BigInt(72283007456311581445415925)) #bhat5-eb5
  ebtilde6 = convert(T,BigInt(13674542533282477231637762)//BigInt(149163814411398370516486131)) #bhat6-eb6
  ebtilde7 = convert(T,BigInt(11939168497868428048898551)//BigInt(210101209758476969753215083)) #bhat7-eb7
  ebtilde8 = -convert(T,BigInt(1815023333875)//BigInt(51666766064334)) #bhat8-eb8
