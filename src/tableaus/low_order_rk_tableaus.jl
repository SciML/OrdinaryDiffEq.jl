...
struct Tsit5TestConstantCache <: OrdinaryDiffEqConstantCache end

struct Tsit5TestConstantCacheActual{T}
    r11::T
    r12::T
    r13::T
    r14::T
...
struct Tsit5TestConstantCacheActual2{T, T2}
    r11::T
    r12::T
    r13::T
    r14::T
...
@fold function Tsit5TestConstantCacheActual(::Type{T}) where {T <: CompiledFloats}
    ...
    c2 = convert(T, 0.327)
    c3 = convert(T, 0.9)
    c4 = convert(T, 0.9800255409045097)
    c5 = convert(T, 1)
    c6 = convert(T, 1)
    a21 = convert(T, 0.161)
    a31 = convert(T, -0.008480655492356989)
    ...
    return r11, r12, r13, r14, r22, r23, r24, r32, r33, r34, r42, r43, r44, r52, r53, r54,
    r62, r63, r64, r72, r73, r74, c1, c2, c3, c4, c5, c6, a21, a31, a32, a41, a42, a43, a51, a52,a53,
    a54, a61, a62, a63, a64, a65, a71, a72, a73, a74, a75, a76,btilde1,btilde2, btilde3, btilde4, btilde5, btilde6, btilde7

end

@fold function Tsit5TestConstantCacheActual(::Type{T}) where {T}
    ...
    return r11, r12, r13, r14, r22, r23, r24, r32, r33, r34, r42, r43, r44, r52, r53, r54,
    r62, r63, r64, r72, r73, r74, c1, c2, c3, c4, c5, c6, a21, a31, a32, a41, a42, a43, a51, a52,
    a53,
    a54, a61, a62, a63, a64, a65, a71, a72, a73, a74, a75, a76,
    btilde1,
    btilde2, btilde3, btilde4, btilde5, btilde6, btilde7
...
@fold function Tsit5TestConstantCacheActual2(::Type{T},::Type{T2}) where {T <: CompiledFloats,T2 <: CompiledFloats}
    ...
    Tsit5TestConstantCacheActual(r11, r12, r13, r14, r22, r23, r24, r32, r33, r34, r42, r43, r44, r52, r53, r54,
                                r62, r63, r64, r72, r73, r74, c1, c2, c3, c4, c5, c6, a21, a31, a32, a41, a42, 
                                a43, a51, a52, a53, a54, a61, a62, a63, a64, a65, a71, a72, a73, a74, a75, a76,
                                btilde1, btilde2, btilde3, btilde4, btilde5, btilde6, btilde7)
end

@fold function Tsit5TestConstantCacheActual2(::Type{T}, ::Type{T2}) where {T, T2}
