...
function DPRKN6ConstantCache(T::Type, T2::Type)
    ...
    bptilde3 = convert(
        T,
        (389225579 + 96856R) / 10_2405_6540 - (8411_9543 + 366_727R) / 2560_14135,
    )
    bptilde4 = convert(
        T,
        (389225579 - 96856R) / 10_2405_6540 - (8411_9543 - 366_727R) / 2560_14135,
...
function DPRKN12ConstantCache(T::Type, T2::Type)
    ...
    a116 = convert(
        T,
        -94634958447010580589908066176109375 // 27549212808177898050085930321520256,
    )
    ...
    a139 =
        convert(T, -493399374030747471036018890494175 // 251658285736841065236836942273664)
    ...
    a154 = convert(
        T,
        16870665568420512953501332587233725 // 955405388268427749593882076788623812,
    )
    a155 = convert(
        T,
    ...
    a157 = convert(
        T,
        parse(BigInt, "4159963831215576225909381034291748993887819834160487158570788681") // parse(
            BigInt,
    ...
    a165 = convert(
        T,
        -127865248353371207265315478623656127 // 10401415428935853634424440540325344,
    )
    a166 = convert(
        T,
    ...
    a1612 =
        convert(T, 398946554885847045598775476868169 // 344154261237450078839899047372800)
    ...
    btilde1 = convert(
        T,
        Int64(63818747) // Int64(5262156900) - Int64(27121957) // Int64(1594593000),
    )
    # btilde2 = convert(T,0)
    # btilde3 = convert(T,0)
    # btilde4 = convert(T,0)
    ...
    btilde9 = convert(
        T,
        Int64(-45359872) // Int64(229764843) + Int64(163199648) // Int64(406149975),
    )
    btilde10 = convert(
        T,
        Int64(19174962087) // Int64(94371046000) - Int64(23359833) // Int64(69636250),
    )
    btilde11 = convert(
        T,
        Int64(-19310468) // Int64(929468925) + Int64(18491714) // Int64(140828625),
    )
    btilde12 = convert(
        T,
    ...
    btilde13 = convert(
        T,
        Int64(1592709632) // Int64(41841694125) - Int64(1191129152) // Int64(44377554375),
    )
    btilde14 = convert(
        T,
    ...
    bptilde9 = convert(
        T,
        Int64(-181439488) // Int64(689294529) + Int64(652798592) // Int64(1218449925),
    )
    bptilde10 = convert(
        T,
        Int64(57524886261) // Int64(188742092000) - Int64(70079499) // Int64(139272500),
    )
    bptilde11 = convert(
        T,
        Int64(-38620936) // Int64(929468925) + Int64(36983428) // Int64(140828625),
    )
    bptilde12 = convert(
        T,
    ...
    bptilde13 = convert(
        T,
        Int64(6370838528) // Int64(41841694125) - Int64(4764516608) // Int64(44377554375),
    )
    bptilde14 = convert(
        T,
