...
function DPRKN6ConstantCache(T::Type,T2::Type)
  ...
  bptilde3 = convert(T,(389225579+96856R)/10_2405_6540 - (8411_9543+366_727R)/2560_14135)
  bptilde4 = convert(T,(389225579-96856R)/10_2405_6540 - (8411_9543-366_727R)/2560_14135)
...
struct DPRKN43TConstantCache{T,T2} <: OrdinaryDiffEqConstantCache
  c1::T2
  c2::T2
  c3::T2
  c4::T2
...
function DPRKN43TConstantCache(::Type{T},::Type{T2}) where {T<:CompiledFloats, T2<:CompiledFloats}
  c1       = convert(T2,0.5)
  c2       = convert(T2,0.5)
  c3       = convert(T2,1.0)
  c4       = convert(T2,1.0)
  ...
  DPRKN43TConstantCache(c1, c2, c3, c4,
                        ...
                        a51, a52, a53, a54,
                        b1, b2, b3, b4, b5,
                        btilde1, btilde2, btilde3, btilde4)
end
...
### dprkn54t
struct DPRKN54TConstantCache{T,T2} <: OrdinaryDiffEqConstantCache
  c1::T2
  c2::T2
  c3::T2
  c4::T2
...
function DPRKN54TConstantCache(::Type{T},::Type{T2}) where {T<:CompiledFloats, T2<:CompiledFloats}
  c1       = convert(T2, 0.125)
  c2       = convert(T2, 0.25)
  c3       = convert(T2, 0.4444444444444444)
  c4       = convert(T2, 0.8)
  c5       = convert(T2, 1.0)
  c6       = convert(T2, 1.0)
  a21      = convert(T, 0.125)
  a32      = convert(T, 0.25)
  a41      = convert(T, 0.26886145404663925)
  a42      = convert(T,-0.438957475994513)
  a43      = convert(T, 0.6145404663923183)
  a51      = convert(T, 0.2907826086956522)
  a52      = convert(T, 0.11130434782608696)
  a53      = convert(T, -0.6646459627329192)
  a54      = convert(T, 1.06255900621118)
  a61      = convert(T, -1.5208333333333333)
  a63      = convert(T, 5.67965367965368)
  a64      = convert(T, -4.520089285714286)
  a65      = convert(T, 1.3612689393939394)
  a71      = convert(T, .08854166666666667)
  a73      = convert(T, 0.27705627705627706)
  a74      = convert(T, 0.24408482142857144)
  a75      = convert(T, 0.34031723484848486)
  a76      = convert(T, .05)
  b1       = convert(T, 0.08854166666666667)
  b3       = convert(T, 0.27705627705627706)
  b4       = convert(T, 0.24408482142857144)
  b5       = convert(T, 0.34031723484848486)
  b6       = convert(T, 0.03333333333333333) # b6 == 1//20 - λ, λ == 1//60
  b7       = convert(T, 0.016666666666666666) # b7 == λ, λ == 1//60
  btilde1  = b1
  btilde3  = b3
  btilde4  = b4
  btilde5  = b5
...
function DPRKN54TConstantCache(T::Type,T2::Type)
  ...
  a75      = convert(T, 2875//8448)
  a76      = convert(T, 1//20)
  b1       = convert(T, 17//192)
  b3       = convert(T, 64//231)
  b4       = convert(T, 2187//8960)
  b5       = convert(T, 2875//8448)
  b6       = convert(T, 1//30) # b6 == 1//20 - λ, λ == 1//60
  b7       = convert(T, 1//60) # b7 == λ, λ == 1//60
  btilde1  = b1
  btilde3  = b3
  btilde4  = b4
  btilde5  = b5
  btilde6  = convert(T,1//20)
  DPRKN54TConstantCache(c1, c2, c3, c4, c5, c6,
                        a21,
                             a32,
                        a41, a42, a43,
...
struct DPRKN76TConstantCache{T,T2} <: OrdinaryDiffEqConstantCache
  c1::T2
  c2::T2
  c3::T2
  c4::T2
...
function DPRKN76TConstantCache(::Type{T},::Type{T2}) where {T<:CompiledFloats, T2<:CompiledFloats}
  c1       = convert(T2,0.1)
  c2       = convert(T2,0.2)
  c3       = convert(T2,0.375)
  c4       = convert(T2,0.5)
  c5       = convert(T2,0.17267316464601143)
  c6       = convert(T2,0.8273268353539885)
  c7       = convert(T2,1.0)
  c8       = convert(T2,1.0)
  a21      = convert(T,0.005)
  a31      = convert(T,0.006666666666666667)
  a32      = convert(T,0.013333333333333334)
  a41      = convert(T,0.0208740234375)
  a42      = convert(T,0.010986328125)
  a43      = convert(T,0.0384521484375)
  a51      = convert(T,0.017361111111111112)
  a52      = convert(T,0.04734848484848485)
  a53      = convert(T,0.03720238095238095)
  a54      = convert(T,0.023088023088023088)
  a61      = convert(T,0.005148362693071982)
  a62      = convert(T,0.011536353484009276)
  a63      = convert(T,-0.002205603110364941)
  a64      = convert(T,0.0005511400022442423)
  a65      = convert(T,-0.00012224217452627166)
  a71      = convert(T,0.13362015346264514)
  a72      = convert(T,-0.2343490628395862)
  a73      = convert(T,1.2586747400701632)
  a74      = convert(T,-0.4229500390438942)
  a75      = convert(T,0.28260903907028684)
  a76      = convert(T,-0.6753699844711915)
  a81      = convert(T,-0.37897426697125)
  a82      = convert(T,0.876391080902251)
  a83      = convert(T,-7.105326676886944)
  a84      = convert(T,2.1355458417119304)
  a85      = convert(T,-0.649094783099141)
  a86      = convert(T,5.540292967251234)
  a87      = convert(T,0.08116583709192003)
  a91      = convert(T,0.05)
  a95      = convert(T,0.17777777777777778)
  a96      = convert(T,0.22521674962414134)
  a97      = convert(T,0.04700547259808089)
  b1       = convert(T,0.05)
  b5       = convert(T,0.17777777777777778)
  b6       = convert(T,0.22521674962414132)
  b7       = convert(T,0.04700547259808089)
  b8       = convert(T,-0.05)
  b9       = convert(T,0.05)
  btilde1  = convert(T,0.05)
  btilde5  = convert(T,0.17777777777777778)
  btilde6  = convert(T,0.22521674962414132)
  btilde7  = convert(T,0.04700547259808089)
  bptilde1 = convert(T,0.05)
  bptilde5 = convert(T,0.35555555555555557)
...
function DPRKN76TConstantCache(T::Type,T2::Type)
  ...
  c3       = convert(T2,3//8)
  c4       = convert(T2,1//2)
  c5       = convert(T2,(7-R)/14)
  c6       = convert(T2,(7+R)/14)
  c7       = convert(T2,1)
  c8       = convert(T2,1)
  a21      = convert(T,1//200)
  a31      = convert(T,1//150)
  a32      = convert(T,1//75)
  a41      = convert(T,171//8192)
  a42      = convert(T,45//4096)
  a43      = convert(T,315//8192)
  a51      = convert(T,5//288)
  a52      = convert(T,25//528)
  a53      = convert(T,25//672)
  a54      = convert(T,16//693)
  a61      = convert(T,(1003-205R)/12348)
  a62      = convert(T,-25(751-173R)/90552)
  a63      = convert(T,25(624-137R)/43218)
  a64      = convert(T,-128(361-79R)/237699)
  a65      = convert(T,(3411-745R)/24696)
  a71      = convert(T,(793+187R)/12348)
  a72      = convert(T,-25(331+113R)/90552)
  a73      = convert(T,25(1044+247R)/43218)
  a74      = convert(T,-128(14885+3779R)/9745659)
  a75      = convert(T,(3327+797R)/24696)
  a76      = convert(T,-(581+127R)/1722)
  a81      = convert(T,-(157-3R)/378)
  a82      = convert(T,25(143-10R)/2772)
  a83      = convert(T,-25(876+55R)/3969)
  a84      = convert(T,1280(913+18R)/596673)
  a85      = convert(T,-(1353+26R)/2268)
  a86      = convert(T,7(1777+377R)/4428)
  a87      = convert(T,7(5-R)/36)
  a91      = convert(T,1//20)
  a95      = convert(T,8//45)
  a96      = convert(T,7(7+R)/360)
  a97      = convert(T,7(7-R)/360)
  b1       = convert(T,1//20)
  b5       = convert(T,8//45)
  b6       = convert(T,7(7+R)/360)
  b7       = convert(T,7(7-R)/360)
  b8       = convert(T,-1//20)
  a1712 = convert(T,parse(BigInt, "-1372659703515496442825084239977218110461")//parse(BigInt, "1313121960368535725613950174847107891200"))
  ...
  a1715 = convert(T,parse(BigInt, "168671028523891369934964082754523881107337")//parse(BigInt, "24062875279623260368388427013982199424119600"))
  # a1716 = convert(T,0)
  ...
  b15 = convert(T,parse(BigInt, "12540904472870916741199505796420811396")//parse(BigInt, "2692319557780977037279406889319526430375"))
  # b16 = convert(T,0)
  # b17 = convert(T,0)
  ...
  bp15 = convert(T,parse(BigInt, "111940113324845802831946788738852162520696")//parse(BigInt, "1316544263754897771229629968877248424453375"))
  bp16 = convert(T,-113178587//12362232960)
  bp17 = convert(T,1//40)

  btilde1 = convert(T,Int64(63818747)//Int64(5262156900) - Int64(27121957)//Int64(1594593000))
  # btilde2 = convert(T,0)
  # btilde3 = convert(T,0)
  # btilde4 = convert(T,0)
  # btilde5 = convert(T,0)
  # btilde6 = convert(T,0)
  btilde7 = convert(T,Int64(22555300000000)//Int64(261366897038247) -
              Int64(4006163300000)//Int64(55441463008113))
  btilde8 = convert(T,Int64(1696514453125)//Int64(6717619827072) -
              Int64(9466403125)//Int64(25445529648))
  btilde9 = convert(T,Int64(-45359872)//Int64(229764843) +
              Int64(163199648)//Int64(406149975))
  btilde10 = convert(T,Int64(19174962087)//Int64(94371046000) -
               Int64(23359833)//Int64(69636250))
  btilde11 = convert(T,Int64(-19310468)//Int64(929468925) +
               Int64(18491714)//Int64(140828625))
  btilde12 = convert(T,Int64(16089185487681)//Int64(146694672924800) -
               Int64(11052304606701)//Int64(58344472186000))
  btilde13 = convert(T,Int64(1592709632)//Int64(41841694125) -
               Int64(1191129152)//Int64(44377554375))
  btilde14 = convert(T,Int64(52675701958271)//Int64(4527711056573100) -
               Int64(2033811086741)//Int64(124730332137000))
  btilde15 = convert(T,parse(BigInt, "12540904472870916741199505796420811396")//parse(BigInt, "2692319557780977037279406889319526430375") - parse(BigInt, "3616943474975740389660406409450169802")//parse(BigInt, "951830146690244407118982233597812374375"))
  # btilde16 = convert(T,0)
  # btilde17 = convert(T,0)
  bptilde1 = convert(T,Int64(63818747)//Int64(5262156900) -
  ...
  bptilde7 = convert(T,Int64(451106000000000)//Int64(4965971043726693) -
               Int64(4217014000000)//Int64(55441463008113))
  bptilde8 = convert(T,Int64(8482572265625)//Int64(26870479308288) -
               Int64(47332015625)//Int64(101782118592))
  bptilde9 = convert(T,Int64(-181439488)//Int64(689294529) +
               Int64(652798592)//Int64(1218449925))
  bptilde10 = convert(T,Int64(57524886261)//Int64(188742092000) -
                Int64(70079499)//Int64(139272500))
  bptilde11 = convert(T,Int64(-38620936)//Int64(929468925) +
                Int64(36983428)//Int64(140828625))
  bptilde12 = convert(T,Int64(144802669389129)//Int64(586778691699200) -
                Int64(99470741460309)//Int64(233377888744000))
  bptilde13 = convert(T,Int64(6370838528)//Int64(41841694125) -
                Int64(4764516608)//Int64(44377554375))
  bptilde14 = convert(T,Int64(368729913707897)//Int64(4527711056573100) -
                Int64(14236677607187)//Int64(124730332137000))
  bptilde15 = convert(T,parse(BigInt, "111940113324845802831946788738852162520696")//parse(BigInt, "1316544263754897771229629968877248424453375") - parse(BigInt, "198066487470143918516004831967805004004")//parse(BigInt, "2855490440070733221356946700793437123125"))
