#!/usr/bin/env julia
"""
Precompilation workload for OrdinaryDiffEq.jl

This script exercises key solvers and problem types to precompile the most
commonly used code paths, reducing first-time-to-solution in CI and production.

Based on compile time analysis from: https://sciml.ai/news/2022/09/21/compile_time/
"""
