...
@testset "ExplicitRK Allocation Tests" begin
    ...
    @testset "$(typeof(solver)) runtime allocation check" for solver in explicit_rk_solvers
        integrator = init(
    ...
    if !isempty(VERSION.prerelease)
        ...
        try
            ...
            @testset "$(typeof(solver)) AllocCheck static analysis" for solver in explicit_rk_solvers
