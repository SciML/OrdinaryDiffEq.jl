...
@muladd function perform_step!(
    ...
    k_10_11 = @inline f(
        uprev +
            dt * (
            a10_11_1 * k_1 + a10_2_11_3 * k_2_3 + a10_3_11_2 * k_3_2 +
    ...
    k_12_13 = @inline f(
        uprev +
            dt * (
            a12_13_1 * k_1 + a12_2_13_3 * k_2_3 + a12_3_13_2 * k_3_2 +
    ...
    u = uprev +
        ...
        a14_1 * k_1 +
            ...
            Vec(a14_2, a14_3) * k_2_3 + Vec(a14_4, a14_5) * k_4_5 +
...
@muladd function perform_step!(
    ...
    k_14 = @inline f(
        uprev +
            ...
            a14_1 * k_1 +
                VectorizationBase.vsum.(
                a14_2_14_3 * k_2_3 + a14_4_14_5 * k_4_5
    ...
    u = uprev +
        ...
        (
        VectorizationBase.vsum.(
            Vec(a15_2, a15_3) * k_2_3 + Vec(a15_4, a15_5) * k_4_5 +
...
@muladd function perform_step!(
    ...
    k_10_11_12_13 = f(
        uprev +
            dt * (
            a_10_11_12_13_1 * k_1 + a_10_2_11_3_12_4_13_5 * k_2_3_4_5 +
    ...
    k_14_15_16_17 = f(
        uprev +
            dt * (
            a_14_15_16_17_1 * k_1 + a_14_2_15_3_16_4_17_5 * k_2_3_4_5 +
    ...
    k_18_19_20_21 = f(
        uprev +
            dt * (
            a_18_19_20_21_1 * k_1 + a_18_2_19_3_20_4_21_5 * k_2_3_4_5 +
    ...
    u = uprev +
        ...
        a22_1 * k_1 +
            VectorizationBase.vsum.(
            Vec(a22_2, a22_3, a22_4, a22_5) * k_2_3_4_5 +
    ...
    if integrator.opts.adaptive
        utilde = dt * (
            btilde_1 * k_1 +
                VectorizationBase.vsum.(
                Vec(btilde_2, btilde_3, btilde_4, btilde_5) *
                    k_2_3_4_5 +
