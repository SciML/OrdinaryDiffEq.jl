...
function explicit_rk_docstring(
    ...
    keyword_default_description = """
        ...
        - `step_limiter`: function of the form `limiter!(u, integrator, p, t)`, applied to each attempted endpoint after the method step and its adaptive error estimate have been computed. For FSAL methods, a non-trivial limiter causes the derivative to be refreshed before the next step; dense interpolants between accepted endpoints are not limited.
