...
@static if VERSION >= v"1.11.0-DEV.469"
    eval(
        Expr(
            ...
            :AutoSwitchCache, :beta1_default, :beta2_default, Symbol("@cache"), :COEFFICIENT_MULTISTEP, :CommonControllerOptions, :CompositeAlgorithm,
            :CompositeController, :CompositeControllerCache, :constvalue, :Convergence, :current_extrapolant,
            :current_interpolant, :DAEAlgorithm, :default_autoswitch, :default_controller, :default_linear_interpolation,
            :default_nlsolve, :DefaultCache, :DEOptions, :DIRK, :Divergence, :dt_required, :DummyController,
            ...
            :handle_callback_modifiers!, :ImplicitSecondOrderAlgorithm, :increment_accept!, :increment_nf!, :increment_reject!, :InterpolationData, :isautoswitch,
