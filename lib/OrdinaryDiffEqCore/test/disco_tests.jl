...
sol_no_disco_rosenbrock = solve(prob_vec, Rodas5P(); callback = cb_vec2, reltol=1e-7, abstol=1e-9)
...
sol_no_disco_tsit5 = solve(prob_vec, Tsit5(); callback = cb_vec2, reltol=1e-7, abstol=1e-9)
