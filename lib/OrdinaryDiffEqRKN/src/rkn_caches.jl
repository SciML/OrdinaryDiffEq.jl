...
struct NystromVIConstantCache{T, T2} <: NystromConstantCache
    tab::NystromVITableau{T, T2}
end

@cache struct NystromVICache{uType, rateType, reducedRateType, uNoUnitsType, T, T2} <:
    NystromMutableCache
    u::uType
    uprev::uType
    fsalfirst::rateType
