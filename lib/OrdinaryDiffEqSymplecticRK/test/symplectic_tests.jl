...
@testset "symplectic $alg with units iip=$iip" for iip in IIPS,
        alg in (LeapfrogDriftKickDrift, VerletLeapfrog, McAte2)
    ...
    sol_g = solve(prob_g, alg(), dt = 0.1u"s")
