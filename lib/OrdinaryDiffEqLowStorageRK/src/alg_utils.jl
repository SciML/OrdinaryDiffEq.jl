...
function default_controller_v7(QT, alg::RDPK3SpFSAL35)
    return NewPIDController(QT, alg; beta=map(Base.Fix1(convert, QT), (0.70, -0.23, 0.00)))
end

function default_controller_v7(QT, alg::RDPK3Sp49)
    return NewPIDController(QT, alg; beta=map(Base.Fix1(convert, QT), (0.25, -0.12, 0.00)))
end
...
function default_controller_v7(QT, alg::RDPK3Sp510)
    return NewPIDController(QT, alg; beta=map(Base.Fix1(convert, QT), (0.47, -0.20, 0.06)))
end

function default_controller_v7(QT, alg::RDPK3SpFSAL510)
    return NewPIDController(QT, alg; beta=map(Base.Fix1(convert, QT), (0.45, -0.13, 0.00)))
end
