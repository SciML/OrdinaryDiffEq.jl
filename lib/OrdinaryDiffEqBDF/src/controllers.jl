...
function setup_controller_cache(
        alg::Union{QNDF, FBDF, DFBDF, MOOSE234}, cache, controller::BDFController, ::Type{E},
    ) where {E}
...
qmax_default(::Union{QNDF, FBDF, DFBDF, MOOSE234}) = 5 // 1
qsteady_min_default(::Union{QNDF, QNDF1, QNDF2, FBDF, DFBDF}) = 9 // 10
qsteady_max_default(::Union{QNDF, QNDF1, QNDF2, FBDF, DFBDF}) = 12 // 10
gamma_default(::Union{QNDF, FBDF, DFBDF, MOOSE234}) = 12 // 10

function default_controller(QT, alg::Union{QNDF, FBDF, DFBDF, MOOSE234})
