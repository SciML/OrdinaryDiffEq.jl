...
@testset "Tsit5 Allocation Tests" begin
    ...
    @testset "$(typeof(solver)) runtime allocation check" for solver in tsit5_solvers
        integrator = init(
    ...
    if !isempty(VERSION.prerelease)
        ...
        try
            ...
            @testset "$(typeof(solver)) AllocCheck static analysis" for solver in tsit5_solvers
