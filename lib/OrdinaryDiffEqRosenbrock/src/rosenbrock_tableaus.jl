...
function Rodas42Tableau(T, T2)
    ...
    C = [
        0     -convert(T, 5.104353600000000)  0     0     0;  
        0     -convert(T, 2.899967805418783)  convert(T, 4.040399359702244)  0     0;  
        0     -convert(T, 32.64449927841361)  -convert(T, 99.35311008728094)  convert(T, 49.99119122405989)   0;  
        0     -convert(T, 76.46023087151691)  -convert(T, 278.5942120829058)  convert(T, 153.9294840910643)  convert(T, 10.97101866258358);  
...
function Rodas4P2Tableau(T, T2)
    ...
    C = [
        0     convert(T, -12.00000000000000)  0     0     0;  
        0     convert(T, -6.354581592719008)  convert(T, 0.338972550544623)  0     0;  
        0     convert(T, -8.575016317114033)  convert(T, -7.606483992117508)  convert(T, 12.224997650124820)   0;  
        0     convert(T, -5.888975457523102)  convert(T, -8.157396617841821)  convert(T, 24.805546872612922)  convert(T, 12.790401512796979);  
...
function Rodas5Tableau(T, T2)
    ...
    C = [
        0     convert(T, -10.31323885133993)  0     0     0     0     0;
        0     convert(T, -21.04823117650003)  convert(T, -7.234992135176716)  0     0     0     0;
        0     convert(T, 32.22751541853323)  convert(T, -4.943732386540191)  convert(T, 19.44922031041879)  0     0     0;
        0     convert(T, -20.69865579590063)  convert(T, -8.816374604402768)  convert(T, 1.260436877740897)  convert(T, -0.7495647613787146)  0     0;
        0     convert(T, -46.22004352711257)  convert(T, -17.49534862857472)  convert(T, -289.6389582892057)  convert(T, 93.60855400400906)  convert(T, 318.3822534212147)  0;
        0     convert(T, 34.20013733472935)   convert(T, -14.15535402717690)  convert(T, 57.82335640988400)  convert(T, 25.83362985412365)  convert(T, 1.408950972071624)  convert(T, -6.551835421242162);
...
function Rodas5PTableau(T, T2)
    ...
    a = [
        0     convert(T, 3.0)  0     0     0;
        0     convert(T, 2.849394379747939)  convert(T, 0.45842242204463923)  0     0;
        0     convert(T, -6.954028509809101)  convert(T, 2.489845061869568)  convert(T, -10.358996098473584)  0;
        0     convert(T, 2.8029986275628964)  convert(T, 0.5072464736228206)  convert(T, -0.3988312541770524)  convert(T, -0.04721187230404641);
    ...
    C = [
        0  convert(T, -14.155112264123755)  0   0   0   0   0;
        0  convert(T, -17.97296035885952)  convert(T, -2.859693295451294) 0   0   0   0;
        0  convert(T, 147.12150275711716)  convert(T, -1.41221402718213) convert(T, 71.68940251302358) 0   0   0;
        0  convert(T, 165.43517024871676)  convert(T, -0.4592823456491126) convert(T, 42.90938336958603) convert(T, -5.961986721573306) 0   0;
        0  convert(T, 24.854864614690072)  convert(T, -3.0009227002832186) convert(T, 47.4931110020768) convert(T, 5.5814197821558125) convert(T, -0.6610691825249471) 0;
        0  convert(T, 30.91273214028599)  convert(T, -3.1208243349937974) convert(T, 77.79954646070892) convert(T, 34.28646028294783) convert(T, -19.097331116725623) convert(T, -28.087943162872662);
