...
ROSENBROCKS_WITH_INTERPOLATIONS = Union{Rosenbrock23ConstantCache, Rosenbrock23Cache,
    ...
    RosenbrockConstantCache, Rosenbrock5ConstantCache,
    RosenbrockCache}
...
"""
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
        cache::Union{RosenbrockConstantCache, Rodas23WConstantCache, Rodas3PConstantCache},
        idxs::Nothing, T::Type{Val{0}}, differential_vars)
    Θ1 = 1 - Θ
...
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
        cache::Union{RosenbrockConstantCache, RosenbrockCache, Rodas23WConstantCache,
...
@muladd function _ode_interpolant(Θ, dt, y₀, y₁, k,
        cache::Union{Rosenbrock5ConstantCache, RosenbrockCache},
        idxs, T::Type{Val{0}}, differential_vars)
    Θ1 = 1 - Θ
    @.. broadcast=false Θ1 *
                        y₀[idxs]+Θ * (y₁[idxs] +
