...
@muladd function perform_step!(integrator, cache::RosenbrockCache, repeat_step = false)
    ...
    @unpack k1, k2, k3, k4, k5, k6, du, du1, du2, f₁, fsalfirst, fsallast, dT, J, W, tmp, uf, tf, linsolve_tmp, jac_config, atmp, weight, stage_limiter!, step_limiter! = cache
    @unpack c₃₂, d, a21, a31, a32, a41, a42, a43, a51, a52, a53, a54, C21, C31, C32, C41, C42, C43, C51, C52, C53, C54, C61, C62, C63, C64, C65, b1, b2, b3, btilde1, btilde2, btilde3, gamma, c2, c3, c4, d1, d2, d3, d4  = cache.tab
...
function initialize!(integrator, cache::Union{RosenbrockConstantCache, RosenbrockConstantCache})
...
@muladd function perform_step!(
        integrator, cache::Union{RosenbrockConstantCache, RosenbrockConstantCache},
        repeat_step = false)
    @unpack t, dt, uprev, u, f, p = integrator
    @unpack tf, uf = cache
