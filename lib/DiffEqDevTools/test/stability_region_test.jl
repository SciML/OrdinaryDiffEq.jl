...
@test @inferred(stability_region(Tsit5()))≈stability_region(Tsit5()) rtol=1e-3
@test @inferred(stability_region(SSPRK104()))≈stability_region(SSPRK104()) rtol=1e-3
@test @inferred(stability_region(ImplicitEuler()))≈stability_region(ImplicitEuler()) rtol=1e-3
