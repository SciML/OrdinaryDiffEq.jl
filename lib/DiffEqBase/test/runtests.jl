...
@time begin
    ...
    if TEST_GROUP ∉ (
        ...
        @time @safetestset "FlexUnits ODE_DEFAULT_NORM" include("flexunits_norm_ext.jl")
        @time @safetestset "Measurements ODE_DEFAULT_NORM" include("measurements_norm_ext.jl")
        @time @safetestset "MonteCarloMeasurements ODE_DEFAULT_NORM" include("montecarlomeasurements_norm_ext.jl")
        @time @safetestset "ReverseDiff ODE_DEFAULT_NORM" include("reversediff_norm_ext.jl")
        @time @safetestset "Tracker ODE_DEFAULT_NORM" include("tracker_norm_ext.jl")
